...
/**
 * Stereochemistry specification for quadrivalent atoms. See {@link ILigancyFourChirality} for
 * further details.
 *
 * @cdk.module data
 *
 * @see ILigancyFourChirality
 */
public class LigancyFourChirality implements ILigancyFourChirality {

    private IAtom chiralAtom;
    private IAtom[] ligandAtoms;
    private Stereo stereo;

    public LigancyFourChirality(IAtom chiralAtom, IAtom[] ligandAtoms, Stereo chirality) {
