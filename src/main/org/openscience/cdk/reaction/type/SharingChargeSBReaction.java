 ...
 **/
public class SharingChargeSBReaction implements IReactionProcess{
	...
	public ReactionSpecification getSpecification() {
		return new ReactionSpecification(
				"http://almost.cubic.uni-koeln.de/jrg/Members/mrc/reactionDict/reactionDict#SharingChargeSBReaction",
				this.getClass().getName(),
				"$Id: SharingChargeSBReaction.java,v 1.6 2006/04/01 08:26:47 mrc Exp $",
				"The Chemistry Development Kit");
	}
	
	/**
	 *  Sets the parameters attribute of the SharingChargeSBReaction object
	 *
	...
	public void setParameters(Object[] params) throws CDKException {
		if (params.length > 1) {
			throw new CDKException("SharingChargeSBReaction only expects one parameter");
		}
	...
	/**
	 *  Gets the parameters attribute of the SharingChargeSBReaction object
	 *
	...
	/**
	 *  Gets the parameterNames attribute of the SharingChargeSBReaction object.
	 *
	...
	/**
	 *  Gets the parameterType attribute of the SharingChargeSBReaction object.
	 *
