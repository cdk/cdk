 ...
 * 
 **/
public class PiBondingMovementReaction implements IReactionProcess{
	...
	public ReactionSpecification getSpecification() {
		return new ReactionSpecification(
				"http://almost.cubic.uni-koeln.de/jrg/Members/mrc/reactionDict/reactionDict#PiBondingMovementReaction",
				this.getClass().getName(),
				"$Id: PiBondingMovementReaction.java,v 1.6 2006/04/01 08:26:47 mrc Exp $",
				"The Chemistry Development Kit");
	}
	
	/**
	 *  Sets the parameters attribute of the PiBondingMovementReaction object
	 *
	...
	public void setParameters(Object[] params) throws CDKException {
		if (params.length > 1) {
			throw new CDKException("PiBondingMovementReaction only expects one parameter");
		}
	...
	/**
	 *  Gets the parameters attribute of the PiBondingMovementReaction object
	 *
	...
	/**
	 *  Gets the parameterNames attribute of the PiBondingMovementReaction object
	 *
	...
	/**
	 *  Gets the parameterType attribute of the PiBondingMovementReaction object
	 *
