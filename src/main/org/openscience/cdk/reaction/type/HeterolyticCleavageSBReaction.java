 ...
 **/
public class HeterolyticCleavageSBReaction implements IReactionProcess{
	...
	public ReactionSpecification getSpecification() {
		return new ReactionSpecification(
				"http://almost.cubic.uni-koeln.de/jrg/Members/mrc/reactionDict/reactionDict#HeterolyticCleavageSBReaction",
				this.getClass().getName(),
				"$Id: HeterolyticCleavageSBReaction.java,v 1.6 2006/04/01 08:26:47 mrc Exp $",
				"The Chemistry Development Kit");
	}
	
	/**
	 *  Sets the parameters attribute of the HeterolyticCleavageSBReaction object.
	 *
	...
	public void setParameters(Object[] params) throws CDKException {
		if (params.length > 1) {
			throw new CDKException("HeterolyticCleavageSBReaction only expects one parameter");
		}
	...
	/**
	 *  Gets the parameters attribute of the HeterolyticCleavageSBReaction object.
	 *
	...
	/**
	 *  Gets the parameterNames attribute of the HeterolyticCleavageSBReaction object.
	 *
	...
	/**
	 *  Gets the parameterType attribute of the HeterolyticCleavageSBReaction object.
	 *
