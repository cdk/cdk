 ...
 **/
public class RadicalSiteHrDeltaReaction implements IReactionProcess{
	...
	public ReactionSpecification getSpecification() {
		return new ReactionSpecification(
				...
				"$Id: RadicalSiteHrDeltaReaction.java,v 1.6 2006/04/01 08:26:47 mrc Exp $",
				"The Chemistry Development Kit");
	}
	
	/**
	 *  Sets the parameters attribute of the RadicalSiteHrDeltaReaction object
	 *
	...
	public void setParameters(Object[] params) throws CDKException {
		if (params.length > 1) {
			throw new CDKException("RadicalSiteHrDeltaReaction only expects one parameter");
		}
	...
	/**
	 *  Gets the parameterNames attribute of the RadicalSiteHrDeltaReaction object
	 *
