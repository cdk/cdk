 ...
 **/
public class RadicalSiteRrGammaReaction implements IReactionProcess{
	...
	public ReactionSpecification getSpecification() {
		return new ReactionSpecification(
				...
				"$Id: RadicalSiteRrGammaReaction.java,v 1.6 2006/04/01 08:26:47 mrc Exp $",
				"The Chemistry Development Kit");
	}
	
	/**
	 *  Sets the parameters attribute of the RadicalSiteRrGammaReaction object
	 *
	...
	public void setParameters(Object[] params) throws CDKException {
		if (params.length > 1) {
			throw new CDKException("RadicalSiteRrGammaReaction only expects one parameter");
		}
	...
	/**
	 *  Gets the parameters attribute of the RadicalSiteRrGammaReaction object.
	 *
	...
	/**
	 *  Gets the parameterNames attribute of the RadicalSiteRrGammaReaction object.
	 *
	...
	/**
	 *  Gets the parameterType attribute of the RadicalSiteRrGammaReaction object.
	 *
