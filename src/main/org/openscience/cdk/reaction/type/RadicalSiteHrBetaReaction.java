 ...
 **/
public class RadicalSiteHrBetaReaction implements IReactionProcess{
	...
	public ReactionSpecification getSpecification() {
		return new ReactionSpecification(
				"http://almost.cubic.uni-koeln.de/jrg/Members/mrc/reactionDict/reactionDict#HydrogenRearrangementBetaReaction",
				this.getClass().getName(),
				"$Id: RadicalSiteHrBetaReaction.java,v 1.6 2006/04/01 08:26:47 mrc Exp $",
				"The Chemistry Development Kit");
	}
	
	/**
	 *  Sets the parameters attribute of the RadicalSiteHrBetaReaction object
	 *
	...
	public void setParameters(Object[] params) throws CDKException {
		if (params.length > 1) {
			throw new CDKException("RadicalSiteHrBetaReaction only expects one parameter");
		}
	...
	/**
	 *  Gets the parameters attribute of the RadicalSiteHrBetaReaction object
	 *
	...
	/**
	 *  Gets the parameterNames attribute of the RadicalSiteHrBetaReaction object.
	 *
