...
public class ElectronContainerDiff extends AbstractChemObjectDiff {
    ...
    public static String diff( IChemObject first, IChemObject second ) {
        ...
        resultString.append(diff("eCount", firstEC.getElectronCount(), secondEC.getElectronCount()));
        resultString.append(ChemObjectDiff.diff(first, second));
        if (resultString.length() > 0) {
            return "ElectronContainerDiff(" + resultString.toString() + ")";
        } else {
            return "";
        }
    }
