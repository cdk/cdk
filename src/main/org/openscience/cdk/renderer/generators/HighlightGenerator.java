...
public final class HighlightGenerator implements IGenerator<IAtomContainer> {
     ...
     * 
     * @param atom   the atom the highlight
     ...
     *
     * @param bond   the bond the highlight
     * @param radius the specified radius
     * @return the shape which will highlight the atom
     */
    ...
    /**
     * An automatically generating color palette. The palette produces pseudo
     * random colors for a given seed.
     */
