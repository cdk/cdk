 ...
 *  charges. From the Bond block it reads the bonds and the orders.
 ...
 *  otherwise the coordinates are read as 3D. <p>
 *
 *  The title of the MOL file is read and can be retrieved with: <pre>
...
public class MDLReader extends DefaultChemObjectReader
{
	...
	/**
	 *  Constructor for the MDLReader object
	 */
	public MDLReader()
	{
	...
	/**
	 *  Gets the format attribute of the MDLReader object
	 *
	...
	/**
	 *  Sets the reader attribute of the MDLReader object
	 *
	...
	public ChemObject read(ChemObject object) throws CDKException
	{
		...
		{
			message = "Only supported are ChemFile and Molecule. ";
			if (object == null)
			{
				message += "Requested type is null.";	
			}
	...
	/**
	 *  Gets the iOSettings attribute of the MDLReader object
	 *
