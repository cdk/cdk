...
public class KabschAlignment {
    ...
    public void align() {
        ...
        */
        ...
        tmpa[0] = (a[1][0]*a[2][1]) - (a[1][1]*a[2][0]);
        tmpa[1] = (a[0][1]*a[2][0]) - (a[0][0]*a[2][1]);
        tmpa[2] = (a[0][0]*a[1][1]) - (a[0][1]*a[1][0]);
        a[0][2] = tmpa[0];
        a[1][2] = tmpa[1];
        a[2][2] = tmpa[2];
    ...
    public void rotateAtomContainer(AtomContainer ac) throws CDKException {
        ...
        for (int i = 0; i < ac.getAtomCount(); i++) {
            ...
            ac.getAtomAt(i).setY3d( U[0][0]*p[i].x + U[0][1]*p[i].y + U[0][2]*p[i].z );
            ac.getAtomAt(i).setZ3d( U[0][0]*p[i].x + U[0][1]*p[i].y + U[0][2]*p[i].z );
        }
    }
