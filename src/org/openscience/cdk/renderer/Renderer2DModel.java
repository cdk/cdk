...
public class Renderer2DModel implements java.io.Serializable, Cloneable, MouseMotionListener {
  ...
  /**
   *  Tells if a tool tip text need to be drawn, i. e. if the user hovers over an atom with text.
   */
  public boolean showTooltip = false;

  /**
   *  The toolTipTexts, as atom/string mappings.
   */
  ...
  /**
   *  Sets the backgroundDimension attribute of the Renderer2DModel object
   *
   * @param  dim  The new backgroundDimension value
   */
  ...
  /**
   *  Sets the kekuleStructure attribute of the Renderer2DModel object
   *
   * @param  kekule  The new kekuleStructure value
   */
  ...
  /**
   *  Sets the colorAtomsByType attribute of the Renderer2DModel object
   *
   * @param  bool  The new colorAtomsByType value
   */
  ...
  /**
   *  Sets the showEndCarbons attribute of the Renderer2DModel object
   *
   * @param  showThem  The new showEndCarbons value
   */
  ...
  /**
   *  Sets the showImplicitHydrogens attribute of the Renderer2DModel object
   *
   * @param  showThem  The new showImplicitHydrogens value
   */
  ...
  /**
   *  Sets the showAromaticity attribute of the Renderer2DModel object
   *
   * @param  showIt  The new showAromaticity value
   */
  ...
  /**
   *  Sets the showAromaticityInCDKStyle attribute of the Renderer2DModel object
   *
   * @param  showIt  The new showAromaticityInCDKStyle value
   */
   ...
   *
   * @param  value  The new showAtomAtomMapping value
   */
  ...
  /**
   *  Gets the zoomedBackgroundDimension attribute of the Renderer2DModel object
   *
   * @return    The zoomedBackgroundDimension value
   */
  ...
  /**
   *  Gets the backgroundDimension attribute of the Renderer2DModel object
   *
   * @return    The backgroundDimension value
   */
  ...
  /**
   *  Gets the kekuleStructure attribute of the Renderer2DModel object
   *
   * @return    The kekuleStructure value
   */
  ...
  /**
   *  Gets the colorAtomsByType attribute of the Renderer2DModel object
   *
   * @return    The colorAtomsByType value
   */
  ...
  /**
   *  Gets the showEndCarbons attribute of the Renderer2DModel object
   *
   * @return    The showEndCarbons value
   */
  ...
  /**
   *  Gets the showImplicitHydrogens attribute of the Renderer2DModel object
   *
   * @return    The showImplicitHydrogens value
   */
  ...
  /**
   *  Gets the showAromaticity attribute of the Renderer2DModel object
   *
   * @return    The showAromaticity value
   */
  ...
  /**
   *  Gets the showAromaticityInCDKStyle attribute of the Renderer2DModel object
   *
   * @return    The showAromaticityInCDKStyle value
   */
   ...
   *
   * @return    The showAtomAtomMapping value
   */
   ...
   *
   * @param  atom  Description of Parameter
   * @return       The atomBackgroundColor value
   */
