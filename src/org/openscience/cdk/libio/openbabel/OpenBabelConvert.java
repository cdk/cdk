...
//		callBABEL(0,null,null,null);
	 ...
	 * 
	 * @param file   File of the molecule
	 * @param string String type of the molecule. 
	 ...
	 * 
	 * @param file   File of the molecule
	 * @param string String type of the output
	 * @param string Additional options for the conversion
	 * 
	 * @see 
	 */
	...
	/**
	 * 
	 * @param path File wich contains the path who babel is
