...
public class ChiClusterDescriptor implements IMolecularDescriptor {
    ...
    public List order3(IAtomContainer atomContainer) {
    ...
    public List order4(IAtomContainer atomContainer) {
        QueryAtomContainer[] queries = new QueryAtomContainer[1];
        try {
    ...
    public List order5(IAtomContainer atomContainer) {
        QueryAtomContainer[] queries = new QueryAtomContainer[1];
        try {
    ...
    public List order6(IAtomContainer atomContainer) {
