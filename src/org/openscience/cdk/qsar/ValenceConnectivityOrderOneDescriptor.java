...
public class ValenceConnectivityOrderOneDescriptor implements Descriptor {
	...
	public Map getSpecification() {
		...
		specs.put("Specification-Reference", "http://qsar.sourceforge.net/dicts/qsar-descriptors:chiValuesVCOO");
	...
	public Object calculate(AtomContainer ac) throws CDKException {
		...
		double val0 = 0;
		double val1 = 0;
		ArrayList chiValuesVCOO = new ArrayList(2);
		...
		chiValuesVCOO.add(new Double(chi1v));
		chiValuesVCOO.add(new Double(chi1v_C));		
		return new ArrayList(chiValuesVCOO);
	}
