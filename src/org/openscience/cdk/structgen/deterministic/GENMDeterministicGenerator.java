 ...
 * </pre>
 * 
 * Please note that the number of isomers generated by this generator can quickly 
	 ...
	 */
	 ...
	 public void DFSM(int[][] adjacency,int number,boolean[] isVisited)
	 {
	  ...
	  public void getFinalStructure(List setOfBasicFragment,int[][] adjacencyMatrix,int[] storedSymbolOfStructure,int[] totalNumberOfThisSet,int totalNumberOfAtomAndBond)
	  {
		  ...
		  if(decomposedNumber>0)
		  {
			 //writeToFile(originalSet,numberOfStructures, originMatrix);
			 convertToMol(originalSet,originMatrix,structures);
//			 convertToSMILES(originalSet,originMatrix,smiles);
		  //	 writeToFile(setOfBasicFragment,numberOfStructures, adjacencyMatrix);
		  }
		  else
		  {
			//writeToFile(setOfBasicFragment,numberOfStructures, adjacencyMatrix);
...
//			convertToSMILES(setOfBasicFragment,adjacencyMatrix,smiles);
		  ...
		  if (structures.size() >= structuresAtATime) fireChange();
	  }
