...
public class APolDescriptorTest extends TestCase {
	...
	public void testAPolDescriptorTest() throws ClassNotFoundException, CDKException, java.lang.Exception {
        Descriptor descriptor = new APolDescriptor() ;
        SmilesParser sp = new SmilesParser();
        Molecule mol = sp.parseSmiles("O=C(O)CC"); 
        HydrogenAdder hAdder = new HydrogenAdder();
        hAdder.addExplicitHydrogensToSatisfyValency(mol);
        assertEquals(10.88, ((DoubleResult)descriptor.calculate(mol)).doubleValue(), 0.01);
	}
}
