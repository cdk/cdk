...
public class AromaticAtomsCountDescriptorTest extends TestCase {
	...
	public void testAromaticAtomsCountDescriptor() throws ClassNotFoundException, CDKException, java.lang.Exception {
		Descriptor descriptor = new AromaticAtomsCountDescriptor();
		Object[] params = {new Boolean(true)};
		descriptor.setParameters(params);
		SmilesParser sp = new SmilesParser();
		AtomContainer mol = sp.parseSmiles("CCOc1ccccc1"); // ethanol
		assertEquals(6, ((Integer)descriptor.calculate(mol)).intValue());
	}
}
