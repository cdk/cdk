 ...
 */
 ...
 public class ConnectivityOrderZeroDescriptorTest extends TestCase {
	...
	public void test2ConnectivityOrderZeroDescriptor() throws ClassNotFoundException, CDKException, java.lang.Exception {
		double [] testResult={2.7071};
		Descriptor descriptor = new ConnectivityOrderZeroDescriptor();
		SmilesParser sp = new SmilesParser();
