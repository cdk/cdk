...
public class CNNRegressionModelTest extends CDKTestCase {
	...
	public static Test suite() {
        ...
        public void testCNNRegressionModel() throws CDKException, java.lang.Exception, QSARModelException {
            ...
            System.out.println("testing CNN");
            ...
            assertTrue(wts != null);
            assertEquals(-1.641526, wts[0], .000001);
            assertEquals(-6.253276, wts[1], .000001);
            assertEquals(-4.670519, wts[2], .000001);
            assertEquals(-4.081125, wts[3], .000001);
