...
public class RearrangementAnion1ReactionTest extends CDKTestCase {
	...
	public void testMappingExample1() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtom mappedProductA2 = (IAtom)ReactionManipulator.getMappedChemObject(setOfReactions.getReaction(0), molecule.getAtomAt(2));
        assertEquals(mappedProductA2, product.getAtomAt(2));
	}
	/**
