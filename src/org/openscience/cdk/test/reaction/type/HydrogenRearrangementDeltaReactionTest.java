...
/**
 * TestSuite that runs a test for the HydrogenRearrangementDeltaReactionTest.
 * Generalized Reaction: [A*]-(C)_4-C5[H] => A([H])-(C_4)-[C5*].
 *
 * @cdk.module test-reaction
 */
public class HydrogenRearrangementDeltaReactionTest extends CDKTestCase {
	
	private IReactionProcess type;
	/**
	 * Constructror of the HydrogenRearrangement5ReactionTest object
	 *
	 */
	public  HydrogenRearrangementDeltaReactionTest() {
		type  = new HydrogenRearrangementDeltaReaction();
	}
    
	public static Test suite() {
		return new TestSuite(HydrogenRearrangementDeltaReactionTest.class);
	}
	/**
	...
	public void testAutomaticSearchCentreActiveExample1() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        molecule.addSingleElectron(new SingleElectron(molecule.getAtom(14)));
