...
public class AminoAcidManipulatorTest extends CDKTestCase {
    ...
    public AminoAcidManipulatorTest(String name) {
        super(name);
    }
    
	public static Test suite() {
		return new TestSuite(AminoAcidManipulatorTest.class);
	}
