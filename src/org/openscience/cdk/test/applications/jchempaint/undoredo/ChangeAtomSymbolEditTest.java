...
public class ChangeAtomSymbolEditTest extends CDKTestCase {
    ...
    /*
     * Test method for
     * 'org.openscience.cdk.applications.jchempaint.undoredo.ChangeAtomSymbolEdit.redo()'
     */
    public void testRedo() {
        ...
        while (it.hasNext()) {
            ...
            edit.undo();
            edit.redo();
            assertTrue(atom.getSymbol() == symbols[1]);
        }
    }

    /*
     * Test method for
     * 'org.openscience.cdk.applications.jchempaint.undoredo.ChangeAtomSymbolEdit.undo()'
     */
    public void testUndo() {
        ...
        while (it.hasNext()) {
            ...
            UndoableEdit edit = new ChangeAtomSymbolEdit(atom, symbols[0],
                    symbols[1]);
            edit.undo();
            assertTrue(atom.getSymbol() == symbols[0]);
        }
    }
