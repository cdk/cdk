...
public class TemplateHandler3D{
	...
	public void loadTemplates() {
		...
		try{	
			ins = this.getClass().getClassLoader().getResourceAsStream("data/templates/ringTemplateStructures.sdf");
		...
		try{
			...
			ins = this.getClass().getClassLoader().getResourceAsStream("data/templates/ringTemplateFingerprints.txt");
			fin = new BufferedReader(new InputStreamReader(ins));
