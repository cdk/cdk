...
public class ForceFieldConfigurator {
	...
	public void setForceFieldConfigurator(String ffname) throws Exception {
		if (ffname.toLowerCase()==ffName && parameterSet!=null){
			...
			if (ffName.equals("mm2")) {
				...
				//f = new File(mm2File);
				//readFile(f);
				ins = this.getClass().getClassLoader().getResourceAsStream("data/mm2.prm");
				...
				//readFile(f);
				ins = this.getClass().getClassLoader().getResourceAsStream("data/mmff94.prm");
	 ...
	 */
	private Atom setAtom(Atom atom, String ID) throws Exception {
		AtomType at = null;
		String key = "";
		Vector data = null;
		Double value = null;
	...
	public Atom configureAtom(Atom atom, String hoseCode, boolean _boolean) throws Exception {
		if (ffName.equals("mm2")){
	 ...
	 */
	public Atom configureMM2BasedAtom(Atom atom, String hoseCode,boolean hetRing) throws Exception {
	 ...
	 * @exception  CDKException  Description of the Exception
	 */
	public Atom configureMMFF94BasedAtom(Atom atom, String hoseCode, boolean isInHetRing) throws Exception {
