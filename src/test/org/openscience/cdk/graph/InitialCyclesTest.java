...
public class InitialCyclesTest {
    ...
    @Test public void cyclesOfLength_empty() {
        assertTrue(new InitialCycles(new int[0][0]).cyclesOfLength(0)
                                                   .isEmpty());
    }

    @Test public void graph() {
        int[][] g = new int[0][0];
        assertThat(new InitialCycles(g).graph(),
                   is(sameInstance(g)));
    }
    ...
    @Test public void lengths_K4() {
        assertThat(new InitialCycles(k4()).lengths(), hasItem(3));
    }

    @Test public void cycles_K4() {
