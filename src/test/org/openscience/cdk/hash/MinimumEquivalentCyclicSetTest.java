...
public class MinimumEquivalentCyclicSetTest {
    ...
    public void testFind_TwoChoices() throws Exception {
        ...
        IAtomContainer dummy = mock(IAtomContainer.class);
        int[][] g = new int[][]{{1, 5, 6}, {0, 2, 8}, {1, 3, 9}, {2, 4, 7},
                                {3, 5, 10}, {0, 4, 11}, {0, 14, 15}, {3, 20, 21},
                                {1, 12, 13}, {2, 22, 23}, {4, 18, 19}, {5, 16, 17},
                                {8, 13}, {8, 12}, {6, 15}, {14, 6}, {11, 17},
                                {16, 11}, {10, 19}, {10, 18}, {7, 21}, {7, 20},
                                {9, 23}, {22, 9}};
    ...
    public void testFind_NoChoice() throws Exception {
        ...
        IAtomContainer dummy = mock(IAtomContainer.class);
        int[][] g = new int[][]{{1, 2, 3}, {0, 4, 9}, {0, 5, 6}, {0, 7, 8},
                                {1}, {2}, {2}, {3}, {3}, {1}};
