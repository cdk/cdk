...
import org.openscience.cdk.formula.MolecularFormulaSetManipulator;
 ...
 */
public class MolecularFormulaSetManipulatorTest extends NewCDKTestCase {
	...
	public void testGetMaxOccurrenceElements_IMolecularFormulaSet() {
		...
		Assert.assertEquals(9, molecularFormula.getIsotopeCount(builder.newIsotope("C")));
		Assert.assertEquals(20, molecularFormula.getIsotopeCount(builder.newIsotope("H")));
		Assert.assertEquals(4, molecularFormula.getIsotopeCount(builder.newIsotope("N")));
		Assert.assertEquals(7, molecularFormula.getIsotopeCount(builder.newIsotope("O")));
	...
	public void testRemove_1() {
		...
		Assert.assertEquals(MolecularFormulaManipulator.getString(mf1), MolecularFormulaManipulator.getString(newMFSet.getMolecularFormula(0)));
		Assert.assertEquals(MolecularFormulaManipulator.getString(mf2), MolecularFormulaManipulator.getString(newMFSet.getMolecularFormula(1)));
		Assert.assertEquals(MolecularFormulaManipulator.getString(mf3), MolecularFormulaManipulator.getString(newMFSet.getMolecularFormula(2)));
	...
	public void testRemove_3() {
		...
		mf2.addIsotope(builder.newIsotope("C"),1);
		mf2.addIsotope(builder.newIsotope("H"),1);
		mf2.addIsotope(builder.newIsotope("O"),1);
