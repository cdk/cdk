...
public class MassToFormulaToolTest extends NewCDKTestCase {
    ...
    public void testMassToFormulaTool()	{
		...
		Assert.assertNotNull(new MassToFormulaTool());
	}
    /**
	 * A unit test suite for JUnit.
	 *
    ...
    public void testMass_0Null(){
		...
		Assert.assertNull(new MassToFormulaTool().generate(0.0));
	}
    /**
	 * A unit test suite for JUnit
	 *
	...
	public void testMass_NegativeNULL(){
		...
		Assert.assertNull(new MassToFormulaTool().generate(-10.0));
	}
    /**
	 * A unit test suite for JUnit
	 *
	...
	public void testGetRestrictions(){
		...
		Assert.assertNotNull(new MassToFormulaTool().getRestrictions());
	}
    /**
	 * A unit test suite for JUnit.
	 *
	...
	public void testGenerate_double(){
		...
		Assert.assertNotNull(new MassToFormulaTool().generate(44.0032));
	}
	...
	public void testValidation_Orthinine(){
		...
		Assert.assertEquals(19,mfSet.size());
		

		Assert.assertEquals(MolecularFormulaManipulator.getAtomCount(mf1), MolecularFormulaManipulator.getAtomCount(mfSet.getMolecularFormula(0)));
		...
		Assert.assertEquals(mf1.getIsotopeCount(ifac.getMajorIsotope("N")), mfSet.getMolecularFormula(0).getIsotopeCount(ifac.getMajorIsotope("N")));
		
		
		Assert.assertEquals(MolecularFormulaManipulator.getAtomCount(mf2), MolecularFormulaManipulator.getAtomCount(mfSet.getMolecularFormula(1)));
		Assert.assertEquals(mf2.getIsotopeCount(), mfSet.getMolecularFormula(1).getIsotopeCount());
		Assert.assertEquals(mf2.getIsotopeCount(ifac.getMajorIsotope("C")), mfSet.getMolecularFormula(1).getIsotopeCount(ifac.getMajorIsotope("C")));
		Assert.assertEquals(mf2.getIsotopeCount(ifac.getMajorIsotope("N")), mfSet.getMolecularFormula(1).getIsotopeCount(ifac.getMajorIsotope("N")));
	...
	public void testValidation_Orthinine_Restrictions() throws CDKException{
		...
		Assert.assertEquals(MolecularFormulaManipulator.getAtomCount(mf1), MolecularFormulaManipulator.getAtomCount(mfSet.getMolecularFormula(0)));
		Assert.assertEquals(mf1.getIsotopeCount(), mfSet.getMolecularFormula(0).getIsotopeCount());
		Assert.assertEquals(mf1.getIsotopeCount(ifac.getMajorIsotope("C")), mfSet.getMolecularFormula(0).getIsotopeCount( ifac.getMajorIsotope("C")));
		Assert.assertEquals(mf1.getIsotopeCount(ifac.getMajorIsotope("N")), mfSet.getMolecularFormula(0).getIsotopeCount( ifac.getMajorIsotope("N")));
	...
	public void testValidation_Arginine_Restrictions() throws CDKException{
		...
		Assert.assertEquals(21,mfSet.size());
		
		Assert.assertEquals(MolecularFormulaManipulator.getAtomCount(mf1), MolecularFormulaManipulator.getAtomCount(mfSet.getMolecularFormula(13)));
		Assert.assertEquals(mf1.getIsotopeCount(), mfSet.getMolecularFormula(13).getIsotopeCount());
		Assert.assertEquals(mf1.getIsotopeCount(ifac.getMajorIsotope("C")), mfSet.getMolecularFormula(13).getIsotopeCount( ifac.getMajorIsotope("C")));
		Assert.assertEquals(mf1.getIsotopeCount(ifac.getMajorIsotope("N")), mfSet.getMolecularFormula(13).getIsotopeCount( ifac.getMajorIsotope("N")));
	...
	public void testMiddleMass() throws CDKException {
		...
		Assert.assertSame(2, mfSet.size());
