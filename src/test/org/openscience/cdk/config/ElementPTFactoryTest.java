...
public class ElementPTFactoryTest extends CDKTestCase
{
    ...
    @Test public void testGetChemicalSerie_PeriodicTablePeriodicTableElement() throws Exception {
		ElementPTFactory elefac = ElementPTFactory.getInstance();
        Assert.assertEquals("Nonmetals", elefac.getChemicalSerie(new PeriodicTableElement("H")));
    }
    
    @Test public void testGetPeriod_PeriodicTablePeriodicTableElement() throws Exception {
		ElementPTFactory elefac = ElementPTFactory.getInstance();
    ...
    @Test public void testGetPhase_PeriodicTablePeriodicTableElement() throws Exception {
		ElementPTFactory elefac = ElementPTFactory.getInstance();
        Assert.assertEquals("Gas", elefac.getPhase(new PeriodicTableElement("H")));
    }
    
    @Test public void testGetVdwRadius_PeriodicTablePeriodicTableElement() throws Exception {
		ElementPTFactory elefac = ElementPTFactory.getInstance();
        Assert.assertEquals(1.2, elefac.getVdwRadius(new PeriodicTableElement("H")), 0.1);
    }
    
    @Test public void testGetCASid_PeriodicTablePeriodicTableElement() throws Exception {
		ElementPTFactory elefac = ElementPTFactory.getInstance();
        Assert.assertEquals("1333-74-0", elefac.getCASid(new PeriodicTableElement("H")));
    }
    
    @Test public void testGetCovalentRadius_PeriodicTablePeriodicTableElement() throws Exception {
		ElementPTFactory elefac = ElementPTFactory.getInstance();
        Assert.assertEquals(0.37, elefac.getCovalentRadius(new PeriodicTableElement("H")), 0.1);
    }
    
    @Test public void testGetPaulingEneg_PeriodicTablePeriodicTableElement() throws Exception {
		ElementPTFactory elefac = ElementPTFactory.getInstance();
