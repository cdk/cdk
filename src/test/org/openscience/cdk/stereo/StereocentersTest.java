...
public class StereocentersTest {
    ...
    @Test public void boron_v4_anion() throws Exception {
    ...
    @Test public void silicon_cation() throws Exception {
        none("[Si+](C)(N)(O)");
    ...
    @Test public void germanium_cation() throws Exception {
        none("[Ge+](C)(N)(O)");
    ...
    @Test public void tin_cation() throws Exception {
        none("[Sn+](C)(N)(O)");
    ...
    @Test public void nitrogen_v3_neutral() throws Exception {
    ...
    @Test public void nitrogen_v3_neutral_in_small_ring() throws Exception {
        tetrahedral("N(C)(C1)O1");
        tetrahedral("N(C)(C1)C1C");
    }

    @Test public void nitrogen_v3_neutral_in_larger_ring() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void nitrogen_v3_neutral_reject_H() throws Exception {
        none("N(C1)C1");  // n.b. equivalence checked later
        none("N(C1)C1C");
    }

    @Test public void nitrogen_v4_cation() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void nitrogen_v4_cation_reject_h() throws Exception {
        none("[NH+](=C)(C)C");
        none("[NH2+](C)C");
        none("[NH3+]C");
        none("[NH4+]");
     ...
     * @throws Exception
     */
    @Test public void nitrogen_v4_cation_reject_h_on_terminal() throws Exception {
        none("[N+](N)([NH])(C)CC");
        none("[N+](O)([O])(C)CC");
        none("[N+](S)([S])(C)CC");
        none("[N+]([SeH])([Se])(C)C");
    ...
    @Test public void nitrogen_v5_neutral() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void nitrogen_v5_neutral_reject_h() throws Exception {
        none("N(=C)(C)(C)");
        none("N(=C)(C)");
        none("N(=C)");
    }
     ...
     * @throws Exception
     */
    @Test public void nitrogen_v5_neutral_reject_h_on_terminal() throws Exception {
        none("N(N)(=N)(C)CC");
        none("N(O)(=O)(C)CC");
        none("N(S)(=S)(C)CC");
        none("N([SeH])(=[Se])(C)C");
    ...
    @Test public void phosphorus_v3_neutral() throws Exception {
        tetrahedral("P(C)(N)(O)");
        none("P(=C)(C)");
        none("P(#C)");
    }
     ...
     * @throws Exception
     */
    @Test public void phosphorus_v3_neutral_reject_H() throws Exception {
        none("P(C)(C)");
        none("P(C)");
        none("P");
    }
     ...
     * @throws Exception
     */
    @Test public void phosphorus_v3_neutral_reject_h_on_terminal() throws Exception {
        none("P(N)([NH4])C");
        none("P(S)([SH4])C");

    }

    @Test public void phosphorus_v4_cation() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void phosphorus_v4_cation_accept_h() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void phosphorus_v4_cation_reject_h_on_terminal() throws Exception {
        none("[P+](N)([N])(C)CC");
        none("[P+](O)([O])(C)CC");
        none("[P+](S)([S])(C)CC");
        none("[P+]([SeH])([Se])(C)CC");
    ...
    @Test public void phosphorus_v5_neutral() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void phosphorus_v5_neutral_reject_h() throws Exception {
        none("P(=C)(C)(C)");
        none("P(=C)(C)");
        none("P(=C)");
    }
     ...
     * @throws Exception
     */
    @Test public void phosphorus_v5_neutral_reject_h_on_terminal() throws Exception {
        none("P(=N)(N)(C)CC");
        none("P(=O)(O)(C)CC");
        none("P(=S)(S)(C)CC");
        none("P(=[Se])([SeH])(C)C");
    ...
    @Test public void arsenic_v4_cation() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void arsenic_v4_cation_accept_h() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void arsenic_v4_cation_reject_h_on_terminal() throws Exception {
        none("[As+](N)([N])(C)CC");
        none("[As+](O)([O])(C)CC");
        none("[As+](S)([S])(C)CC");
        none("[As+]([SeH])([Se])(C)CC");
    ...
    @Test public void sulphur_4v_neutral() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void sulphur_4v_neutral_reject_h() throws Exception {
        none("S(=O)(C)");
        none("S(=O)");
    }
     ...
     * @throws Exception
     */
    @Test public void sulphur_4v_neutral_reject_h_on_terminal() throws Exception {
        none("S(=N)(N)C");
        none("S(=O)(O)C");
        none("S(=S)(S)C");
        none("S(=[Se])([SeH])C");
    ...
    @Test public void sulphur_3v_cation() throws Exception {
        tetrahedral("[S+](C)(N)(O)");
        none("[S+](=C)(C)");
    }

    @Test public void sulphur_1v_anion() throws Exception {
        none("[S-](C)");
    }
     ...
     * @throws Exception
     */
    @Test public void sulphur_3v_cation_reject_h() throws Exception {
        none("[SH+](C)(C)");
        none("[SH2+](C)");
    }
     ...
     * @throws Exception
     */
    @Test public void sulphur_3v_cation_reject_h_on_terminal() throws Exception {
        none("[S+](N)([N])(C)");
        none("[S+](O)([O])(C)");
        none("[S+]([SeH])([Se])(C)");
        none("[S+]([TeH])([Te])(C)");
    ...
    @Test public void sulphur_6v_neutral() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void sulphur_6v_neutral_reject_h() throws Exception {
        none("S(=C)(=C)(C)");
        none("S(=C)(=C)");
    }
     ...
     * @throws Exception
     */
    @Test public void sulphur_6v_neutral_reject_h_on_terminal() throws Exception {
        none("S(=N)(=C)(N)(C)");
        none("S(=O)(=C)(O)(C)");
        none("S(=S)(=C)(S)(C)");
        none("S(=[Se])(=C)([SeH])(C)");
    ...
    @Test public void sulphur_5v_cation() throws Exception {
        tetrahedral("[S+](=C)(N)(O)(C)");
        none("[S+](C)(C)(C)(C)(C)");
    }

    @Test public void sulphur_3v_anion() throws Exception {
        none("[S-](C)(C)(C)");
        none("[S-](=C)(C)");
    }
     ...
     * @throws Exception
     */
    @Test public void sulphur_5v_cation_reject_h() throws Exception {
        none("[SH+](=C)(CC)(CCC)");
        none("[SH2+](=C)(C)");
        none("[SH3+](=C)");
    }
     ...
     * @throws Exception
     */
    @Test public void sulphur_5v_cation_reject_h_on_terminal() throws Exception {
        none("[S+](=N)(N)(C)(CC)");
        none("[S+](=O)(O)(C)(CC)");
        none("[S+](=[Se])([SeH])(C)(CC)");
        none("[S+](=[Te])([TeH])(C)(CC)");
    ...
    @Test public void selenium_4v_neutral() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void selenium_4v_neutral_reject_h() throws Exception {
        none("[SeH](=O)(C)");
        none("[SeH2](=O)");
    }
     ...
     * @throws Exception
     */
    @Test public void selenium_4v_neutral_reject_h_on_terminal() throws Exception {
        none("[Se](=N)(N)C");
        none("[Se](=O)(O)C");
        none("[Se](=S)(S)C");
        none("[Se](=[Se])([SeH])C");
    ...
    @Test public void selenium_3v_cation() throws Exception {
        tetrahedral("[Se+](C)(CC)(CCC)");
        none("[Se+](=C)(C)");
    }

    @Test public void selenium_1v_anion() throws Exception {
        none("[Se-](C)");
    }
     ...
     * @throws Exception
     */
    @Test public void selenium_3v_cation_reject_h() throws Exception {
        none("[SeH+](C)(C)");
        none("[SeH2+](C)");
    }
     ...
     * @throws Exception
     */
    @Test public void selenium_3v_cation_reject_h_on_terminal() throws Exception {
        none("[Se+](N)(=N)(C)C");
        none("[Se+](O)(=O)(C)C");
        none("[Se+](O)(=O)(C)C");
        none("[Se+]([SeH])(=[Se])(C)C");
    ...
    @Test public void selenium_6v_neutral() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void selenium_6v_neutral_reject_h() throws Exception {
        none("[SeH](=C)(=C)(C)");
        none("[SeH2](=C)(=C)");
    }
     ...
     * @throws Exception
     */
    @Test public void selenium_6v_neutral_reject_h_on_terminal() throws Exception {
        none("[Se](=N)(=N)(N)(C)");
        none("[Se](=O)(=O)(O)(C)");
        none("[Se](=S)(=S)(S)(C)");
        none("[Se](=[Se])(=[Se])([SeH])(C)");
    ...
    @Test public void selenium_5v_cation() throws Exception {
        tetrahedral("[Se+](=C)(CC)(CCC)(CCCC)");
        none("[Se+](C)(CC)(CCC)(CCCC)(CCCCC)");
    }

    @Test public void selenium_3v_anion() throws Exception {
        none("[Se-](C)(C)(C)");
        none("[Se-](=C)(C)");
    }
     ...
     * @throws Exception
     */
    @Test public void selenium_5v_cation_reject_h() throws Exception {
        none("[SeH+](=C)(C)(CC)");
        none("[SeH2+](=C)(C)");
        none("[SeH3+](=C)");
    }
     ...
     * @throws Exception
     */
    @Test public void selenium_5v_cation_reject_h_on_terminal() throws Exception {
        none("[Se+](=N)(N)(C)(CC)");
        none("[Se+](=O)(O)(C)(CC)");
        none("[Se+](=[Se])([SeH])(C)(CC)");
        none("[Se+](=[Te])([TeH])(C)(CC)");
    ...
    void test(IAtomContainer container, Stereocenters.Type type, String mesg) {
        ...
        assertThat(mesg + " (unsupressed hydrogens)",
                   Stereocenters.of(container).elementType(0),
                   is(type));
    }
}
