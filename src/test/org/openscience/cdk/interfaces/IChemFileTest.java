 ...
 */
public class IChemFileTest extends IChemObjectTest {

    @Test public void testAddChemSequence_IChemSequence() {
        IChemFile cs = getBuilder().newChemFile();
        cs.addChemSequence(getBuilder().newChemSequence());
        cs.addChemSequence(getBuilder().newChemSequence());
        cs.addChemSequence(getBuilder().newChemSequence());
    ...
    @Test public void testGetChemSequence_int() {
        IChemFile cs = getBuilder().newChemFile();
        cs.addChemSequence(getBuilder().newChemSequence());
        IChemSequence second = getBuilder().newChemSequence();
    ...
    @Test public void testGrowChemSequenceArray() {
        ...
        cs.addChemSequence(getBuilder().newChemSequence());
        cs.addChemSequence(getBuilder().newChemSequence());
        cs.addChemSequence(getBuilder().newChemSequence()); // this one should enfore array grow
    ...
    @Test public void testStateChanged_IChemObjectChangeEvent() {
        ...
        chemObject.addChemSequence(getBuilder().newChemSequence());
    ...
    @Test public void testClone_ChemSequence() throws Exception {
		IChemFile file = getBuilder().newChemFile();
		file.addChemSequence(getBuilder().newChemSequence()); // 1
		file.addChemSequence(getBuilder().newChemSequence()); // 2
		file.addChemSequence(getBuilder().newChemSequence()); // 3
		file.addChemSequence(getBuilder().newChemSequence()); // 4
