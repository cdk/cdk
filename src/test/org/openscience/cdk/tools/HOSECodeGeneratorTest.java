 ...
 */
public class HOSECodeGeneratorTest extends NewCDKTestCase {
	 ...
	 * @cdk.bug 968852
	 */
	@Test public void test968852() throws Exception {
	 ...
	 */
	@Test public void testSecondSphere() throws Exception {
	...
	@Test public void test1Sphere() throws Exception
	{
		...
		{ 
		  ...
		  mol.addBond(b7);
		  IBond b8 = mol.getBuilder().newBond(a9, a8, IBond.Order.SINGLE);
		  mol.addBond(b8);
		  IBond b9 = mol.getBuilder().newBond(a10, a9, IBond.Order.SINGLE);
		  mol.addBond(b9);
		  IBond b10 = mol.getBuilder().newBond(a11, a10, IBond.Order.DOUBLE);
		  mol.addBond(b10);
		  IBond b11 = mol.getBuilder().newBond(a12, a11, IBond.Order.SINGLE);
		  mol.addBond(b11);
		  IBond b12 = mol.getBuilder().newBond(a13, a12, IBond.Order.DOUBLE);
		  mol.addBond(b12);
		  IBond b13 = mol.getBuilder().newBond(a14, a13, IBond.Order.SINGLE);
		  mol.addBond(b13);
		  IBond b14 = mol.getBuilder().newBond(a14, a9, IBond.Order.DOUBLE);
		  mol.addBond(b14);
		  IBond b15 = mol.getBuilder().newBond(a15, a14, IBond.Order.SINGLE);
		  mol.addBond(b15);
		  IBond b16 = mol.getBuilder().newBond(a16, a15, IBond.Order.SINGLE);
		  mol.addBond(b16);
		  IBond b17 = mol.getBuilder().newBond(a17, a16, IBond.Order.DOUBLE);
		  mol.addBond(b17);
		  IBond b18 = mol.getBuilder().newBond(a18, a17, IBond.Order.SINGLE);
		  mol.addBond(b18);
		  IBond b19 = mol.getBuilder().newBond(a19, a18, IBond.Order.SINGLE);
		  mol.addBond(b19);
		  IBond b20 = mol.getBuilder().newBond(a20, a17, IBond.Order.SINGLE);
		  mol.addBond(b20);
		  IBond b21 = mol.getBuilder().newBond(a21, a20, IBond.Order.DOUBLE);
		  mol.addBond(b21);
		  IBond b22 = mol.getBuilder().newBond(a21, a2, IBond.Order.SINGLE);
		  mol.addBond(b22);
		  IBond b23 = mol.getBuilder().newBond(a22, a21, IBond.Order.SINGLE);
		  mol.addBond(b23);
		  IBond b24 = mol.getBuilder().newBond(a22, a5, IBond.Order.DOUBLE);
		  mol.addBond(b24);
		  IBond b25 = mol.getBuilder().newBond(a23, a22, IBond.Order.SINGLE);
		  mol.addBond(b25);
		  IBond b26 = mol.getBuilder().newBond(a23, a16, IBond.Order.SINGLE);
		  mol.addBond(b26);
		  IBond b27 = mol.getBuilder().newBond(a23, a8, IBond.Order.DOUBLE);
		  mol.addBond(b27);
