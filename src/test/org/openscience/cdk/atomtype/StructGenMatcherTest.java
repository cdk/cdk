...
public class StructGenMatcherTest extends AbstractAtomTypeTest {
    ...
    @Test public void testArsenic() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            mol.addAtom(atom);
            IBond bond = DefaultChemObjectBuilder.getInstance().newInstance(IBond.class,atom, atom1, IBond.Order.SINGLE);
            mol.addBond(bond);
        }
    ...
    @Test public void testS2() throws Exception {
        ...
        mol = DefaultChemObjectBuilder.getInstance().newInstance(IMolecule.class);
