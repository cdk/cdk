...
public class ParserTest extends CDKTestCase {
    ...
    @Test public void testPropertyCharge1() throws Exception {
        Assert.assertEquals(0, match("[+1]", "[OH-].[Mg+2]", false));
    }

    @Test public void testPropertyCharge2() throws Exception {
        Assert.assertEquals(1, match("[+1]", "COCC(O)Cn1ccnc1[N+](=O)[O-]", false));
    }

    @Test public void testPropertyCharge3() throws Exception {
        Assert.assertEquals(1, match("[+1]", "[NH4+]", false));
    }

    @Test public void testPropertyCharge4() throws Exception {
        Assert.assertEquals(0, match("[+1]", "CN1C(=O)N(C)C(=O)C(N(C)C=N2)=C12", false));
    }

    @Test public void testPropertyCharge5() throws Exception {
        Assert.assertEquals(2, match("[+1]", "[Cl-].[Cl-].NC(=O)c2cc[n+](COC[n+]1ccccc1C=NO)cc2", false));
    }
    ...
    @Test public void testBondRing5() throws Exception {
        ...
        Assert.assertEquals(30, m);
    }

    @Test public void testBondRing6() throws Exception {
        int m = match("[C,c]@[C,c]", "N12CCC36C1CC(C(C2)=CCOC4CC5=O)C4C3N5c7ccccc76", false);
        Assert.assertEquals(44, m);
    }

    @Test public void testBondStereo1() throws Exception { //TODO: Stereo bond not implemented in smiles parser?
    ...
    @Test public void testLogicalNot9() throws Exception {
    ...
    /*
    @Test public void testLogicalOrLowAnd6() throws Exception { //TODO: this takes very long
    ...
    */
    ...
    @Test public void testRing7() throws Exception {
