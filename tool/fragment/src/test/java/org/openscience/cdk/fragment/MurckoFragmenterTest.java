...
class MurckoFragmenterTest extends CDKTestCase {
    ...
    @Test
    void testNoFramework() throws CDKException {
    ...
    @Test
    void testOnlyRingSystem() throws CDKException {
    ...
    @Test
    void testMF3_Container() throws Exception {
        IAtomContainer mol = smilesParser.parseSmiles("C(CC1=C2C=CC=CC2=CC2=C1C=CC=C2)C1CCCCC1");
        fragmenter.generateFragments(mol);
    ...
    @Test
    void testMF1_Container() throws Exception {
        IAtomContainer mol = smilesParser.parseSmiles("c1ccccc1PP(B)c1cccc(N(N)N)c1SC1CCC1");
        MurckoFragmenter fragmenter = new MurckoFragmenter(false, 2);
    ...
    @Test
    void testSingleFramework() throws Exception {
        IAtomContainer mol = smilesParser.parseSmiles("C1(c2ccccc2)(CC(CC1)CCc1ccccc1)CC1C=CC=C1");
     ...
     */
    @Test
    void testBug1848591() throws Exception {
     ...
     */
    @Test
    void testPirenperone_Bug3088164() throws Exception {
        SmilesGenerator sg = SmilesGenerator.unique().aromatic();
     ...
     */
    @Test
    void testIsomoltane_Bug3088164() throws Exception {
        SmilesGenerator sg = SmilesGenerator.unique().aromatic();
     ...
     */
    @Test
    void testCHEMBL529226() throws CDKException {
