...
/**
 * The union of all the smallest set of equivalent values are members of a ring. This class is
 * intended to drive the systematic perturbation of the {@link
 * org.openscience.cdk.hash.PerturbedAtomHashGenerator}. The method is more comprehensive then a
 * single {@link MinimumEquivalentCyclicSet} and not as computationally demanding as {@link
 * AllEquivalentCyclicSet}. In reality one should choose either use the fast (but good) heuristic
 * {@link MinimumEquivalentCyclicSet} or the exact {@link AllEquivalentCyclicSet}. This method is
 * provided for demonstration only.
 *
 * <p>As with the {@link MinimumEquivalentCyclicSet} perturbation, this method does not guarantee
 * that all molecules will be distinguished. At the time of writing (Feb 2013) there are only 8
 * structure in PubChem-Compound which need the more comprehensive perturbation method ({@link
 * AllEquivalentCyclicSet}), these are listed below.
 *
 * <table>
 * <tr><td>CID <a href="http://pubchem.ncbi.nlm.nih.gov/summary/summary.cgi?cid=144432">144432</a>
 ...
 * @deprecated provided for to demonstrate a relatively robust but ultimately incomplete approach
 * @cdk.githash
 */
@Deprecated
