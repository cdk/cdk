...
/**
 * Geometric parity for 3D tetrahedral geometry. This class requires four 3D coordinates. The 3D
 * coordinates correspond to the four ligands of a tetrahedral atom. If a tetrahedral atom has an
 * implicit hydrogen (only 3 ligands) the forth coordinate should be that of the atom at the centre
...
final class Tetrahedral3DParity extends GeometricParity {
    ...
    /**
     * Create a new geometric parity for 3D tetrahedral geometry by specifying the coordinates.
     *
