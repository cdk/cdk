...
public class BasicAtomHashGeneratorTest {
    ...
    public void testGenerate_ZeroDepth() throws Exception {
        ...
        BasicAtomHashGenerator generator =
                new BasicAtomHashGenerator(mock(AtomHashGenerator.class), new Xorshift(), 0);
    ...
    public void testGenerate_Disconnected() throws Exception {
        ...
        BasicAtomHashGenerator generator =
                new BasicAtomHashGenerator(mock(AtomHashGenerator.class), new Xorshift(), 2);
    ...
    public void testRotation() throws Exception {
        ...
        assertThat(
                value,
                is(generator.distribute(21) ^ 31 ^ generator.rotate(31) ^ generator.rotate(31, 2)));
    }
}
