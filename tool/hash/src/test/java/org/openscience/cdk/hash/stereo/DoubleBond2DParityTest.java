...
public class DoubleBond2DParityTest {
    ...
    public void unspecified() throws Exception {
        GeometricParity geometric = new DoubleBond2DParity(new Point2d(-2.6518, 0.1473),
                                                           new Point2d(-1.8268, 0.1473),
                                                           new Point2d(-3.0643, 0.8618),
                                                           new Point2d(-1.4143, 0.1473));
    ...
    public void opposite30() throws Exception {
        GeometricParity geometric = new DoubleBond2DParity(new Point2d(-2.4455, 0.5046),
                                                           new Point2d(-2.0330, -0.2099),
                                                           new Point2d(-2.0330, 1.2191),
                                                           new Point2d(-2.4455, -0.9244));
        assertEquals(OPPOSITE, geometric.parity());
    }
