...
public class SuppressedAtomHashGeneratorTest {
    ...
    public void testGenerate() throws Exception {
        ...
        AtomHashGenerator generator =
                new SuppressedAtomHashGenerator(
                        seedMock, new Xorshift(), AtomSuppression.unsuppressed(), 0);
    ...
    public void testGenerate_ZeroDepth() throws Exception {
        ...
        SuppressedAtomHashGenerator generator =
                new SuppressedAtomHashGenerator(
                        mock(AtomHashGenerator.class),
                        new Xorshift(),
    ...
    public void testGenerate_Disconnected() throws Exception {
        ...
        assertThat(
                generator.generate(
                        ...
                        new int[][] {{}, {}, {}},
                        Suppressed.none()),
                is(new long[] {expected, expected, expected}));
        BitSet suppressed = new BitSet();
        suppressed.set(1);
        assertThat(
                generator.generate(
                        ...
                        new int[][] {{}, {}, {}},
                        Suppressed.fromBitSet(suppressed)),
                is(new long[] {expected, 0L, expected}));
    }
    ...
    public void testGenerate_Simple() throws Exception {
        ...
        suppressed.set(2);
        {
            long[] first =
                    new long[] {
                        generator.distribute(1) ^ 2L,
                        generator.distribute(2L)
                                ^ 1L, // generator.rotate(1L) not included is '[2]' is suppressed
                        0L,
                    };

            long[] second =
                    new long[] {
                        generator.distribute(first[0])
                                ^ first[
                                        1], // generator.rotate(first[2]) not included is '[2]' is
                                            // suppressed
                        generator.distribute(first[1]) ^ first[0],
                        0L
                    };
    ...
    public void testRotation() throws Exception {
        ...
        // non-suppressed
        {
            ...
            assertThat(
                    value,
                    is(
                            generator.distribute(21)
                                    ^ 31
                                    ^ generator.rotate(31)
                                    ^ generator.rotate(31, 2)));
        }
        ...
        // okay now suppress vertices 1
        {
            ...
            long value =
                    generator.next(
                            graph, 0, invs, unique, rotated, Suppressed.fromBitSet(suppressed));

            assertThat(unique, is(new long[] {31, 0, 0, 0}));
            assertThat(
                    rotated,
                    is(new long[] {generator.rotate(31, 1), 0, 0, 0})); // 31 only encountered twice
        ...
        // okay now suppress vertices 1 and 3
        {
            ...
            assertThat(
                    rotated,
                    is(new long[] {31, 0, 0, 0})); // 31 only encountered once and is not rotated
