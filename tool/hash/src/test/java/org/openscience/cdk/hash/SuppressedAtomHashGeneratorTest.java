...
public class SuppressedAtomHashGeneratorTest {
    ...
    public void testGenerate() throws Exception {
        ...
        AtomHashGenerator generator = new SuppressedAtomHashGenerator(seedMock,
                                                                      new Xorshift(),
    ...
    public void testGenerate_Simple() throws Exception {
        ...
        suppressed.set(2);
        {
            long[] first = new long[]{
                    generator.distribute(1) ^ 2L,
                    generator.distribute(2L) ^ 1L,  // generator.rotate(1L) not included is '[2]' is suppressed
                    0L,
            };

            long[] second = new long[]{
                    generator.distribute(first[0]) ^ first[1], // generator.rotate(first[2]) not included is '[2]' is suppressed
