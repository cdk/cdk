 ...
 */
public class HashCoverageTest extends CoverageAnnotationTest {

    private final static String CLASS_LIST = "hash.javafiles";

    @BeforeClass
    public static void setUp() throws Exception {
        loadClassList(CLASS_LIST, HashCoverageTest.class.getClassLoader());
    }
