...
public class FurtherAtomPlacer3DTest extends AtomPlacer3DTest {
    ...
    public void testNumberOfUnplacedHeavyAtoms_IAtomContainer() {
        IAtomContainer molecule = MoleculeFactory.makeAlkane(SilentChemObjectBuilder.getInstance(), 5);
        for (int i = 0; i < 3; i++) {
    ...
    public void testGetPlacedHeavyAtom_IAtomContainer_IAtom_IAtom() {
        AtomPlacer3D atmplacer = new AtomPlacer3D();
        IAtomContainer molecule = MoleculeFactory.makeAlkane(SilentChemObjectBuilder.getInstance(), 7);
        for (int j = 0; j < 5; j++) {
            molecule.getAtom(j).setFlag(CDKConstants.ISPLACED, true);
        }
    ...
    public void testGetPlacedHeavyAtom_IAtomContainer_IAtom() {
        AtomPlacer3D atmplacer = new AtomPlacer3D();
        IAtomContainer molecule = MoleculeFactory.makeCyclohexane(SilentChemObjectBuilder.getInstance());
    ...
    public void testGeometricCenterAllPlacedAtoms_IAtomContainer() {
        AtomPlacer3D atmplacer = new AtomPlacer3D();
        IAtomContainer molecule = MoleculeFactory.makeAlkane(SilentChemObjectBuilder.getInstance(), 2);
    ...
    public void testGetUnplacedRingHeavyAtom_IAtomContainer_IAtom() {
        AtomPlacer3D atmplacer = new AtomPlacer3D();
        IAtomContainer molecule = MoleculeFactory.makeCyclopentane(SilentChemObjectBuilder.getInstance());
    ...
    public void testGetNextPlacedHeavyAtomWithUnplacedRingNeighbour_IAtomContainer() {
        AtomPlacer3D atmplacer = new AtomPlacer3D();
        IAtomContainer acyclicAlkane = MoleculeFactory.makeAlkane(SilentChemObjectBuilder.getInstance(), 3);
        IAtomContainer cycloPentane = MoleculeFactory.makeCyclopentane(SilentChemObjectBuilder.getInstance());
    ...
    public void testGetNextPlacedHeavyAtomWithUnplacedAliphaticNeighbour_IAtomContainer() {
        AtomPlacer3D atmplacer = new AtomPlacer3D();
        IAtomContainer benzene = MoleculeFactory.makeBenzene(SilentChemObjectBuilder.getInstance());
        IAtomContainer acyclicAlkane = MoleculeFactory.makeAlkane(SilentChemObjectBuilder.getInstance(), 5);
    ...
    public void testGetNextUnplacedHeavyAtomWithAliphaticPlacedNeighbour_IAtomContainer() {
        AtomPlacer3D atmplacer = new AtomPlacer3D();
        IAtomContainer cyclobutane = MoleculeFactory.makeCyclobutane(SilentChemObjectBuilder.getInstance());
        IAtomContainer acyclicAlkane = MoleculeFactory.makeAlkane(SilentChemObjectBuilder.getInstance(), 6);
