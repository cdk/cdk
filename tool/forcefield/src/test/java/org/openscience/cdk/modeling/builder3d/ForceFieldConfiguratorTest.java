...
public class ForceFieldConfiguratorTest {
    ...
    public void testSetForceFieldConfigurator_String() throws CDKException {
        ...
        forceFieldConfigurator.setForceFieldConfigurator(
                forceFieldName, DefaultChemObjectBuilder.getInstance());
    ...
    public void testConfigureMMFF94BasedAtom_IAtom_String_boolean_propanamide()
        ...
        ffc.configureMMFF94BasedAtom(
                amideN, new HOSECodeGenerator().getHOSECode(pa, amideN, 3), false);
    ...
    public void testConfigureMMFF94BasedAtom_IAtom_String_boolean_urea() throws CDKException {
        ...
        ffc.configureMMFF94BasedAtom(
                amideN, new HOSECodeGenerator().getHOSECode(urea, amideN, 3), false);
    ...
    public void testAssignAtomTyps_bug() throws Exception {
        ...
        forceFieldConfigurator.configureMMFF94BasedAtom(
                amideN, new HOSECodeGenerator().getHOSECode(bugmol, amideN, 3), false);
        //		System.err.println(amideN.getAtomTypeName());
        assertEquals("NC=O", amideN.getAtomTypeName());
    }
    ...
    public void testAssignAtomTyps_bug_so2() throws Exception {
        ...
        forceFieldConfigurator.configureAtom(
                sulphur, hscodegen.getHOSECode(bugmol, sulphur, 3), false);
    ...
    public void testAssignAtomTyps_bug_nitrogenatomType() throws Exception {
        ...
        HOSECodeGenerator hscodegen = new HOSECodeGenerator();
        forceFieldConfigurator.configureAtom(
                nitrogen1, hscodegen.getHOSECode(bugmol, nitrogen1, 3), false);
        forceFieldConfigurator.configureAtom(
                nitrogen2, hscodegen.getHOSECode(bugmol, nitrogen2, 3), false);
        forceFieldConfigurator.configureAtom(
                nitrogen3, hscodegen.getHOSECode(bugmol, nitrogen3, 3), false);
