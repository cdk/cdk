...
public class MM2BasedParameterSetReader {
    ...
    private final String              configFile = "org/openscience/cdk/modeling/forcefield/data/mm2.prm";
    ...
    private void setForceFieldDefinitions() throws Exception {
        ...
        if (sid.equals(">bontunit")) {
            try {
                double value1 = Double.valueOf(svalue);
                key = sid.substring(1);
    ...
    private void setvdWaals() throws Exception {
        ...
        try {
            double epsi = Double.valueOf(sepsi);
