...
public class NitrogenRuleTest extends FormulaRuleTest {
    ...
    public void testDefaultValidFalse_SetParam()
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMajorIsotopeMolecularFormula("C2H11N4O4", builder);
        formula.setCharge(1);
    ...
    public void testDefaultValidTrue() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMajorIsotopeMolecularFormula("C4H13N1O5", builder);
        formula.setCharge(0);
    ...
    public void testC45H75NO15() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMajorIsotopeMolecularFormula("C45H75NO15", builder);
        formula.setCharge(0);
    ...
    public void testC45H71N7O10() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMajorIsotopeMolecularFormula("C45H71N7O10", builder);
        formula.setCharge(0);
    ...
    public void testC49H75NO12() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMajorIsotopeMolecularFormula("C49H75NO12", builder);
        formula.setCharge(0);
    ...
    public void testC50H95NO10() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMajorIsotopeMolecularFormula("C50H95NO10", builder);
        formula.setCharge(0);
    ...
    public void testC47H75N5O10() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMajorIsotopeMolecularFormula("C47H75N5O10", builder);
        formula.setCharge(0);
    ...
    public void testC36H42N2O23() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMajorIsotopeMolecularFormula("C36H42N2O23", builder);
        formula.setCharge(0);
    ...
    public void testN() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMajorIsotopeMolecularFormula("NH3", builder);
        formula.setCharge(0);
    ...
    public void testNominalMass() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMolecularFormula("C25H53NO7P", builder);
        formula.setCharge(1);
    ...
    public void testDoubleCharge() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMolecularFormula("C22H34N2S2", builder);
        formula.setCharge(2);
    ...
    public void testWithFe() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMolecularFormula("C40H46FeN6O8S2", builder);
        formula.setCharge(2);
    ...
    public void testWithCo() throws ClassNotFoundException, CDKException, Exception {
        ...
        IMolecularFormula formula =
                MolecularFormulaManipulator.getMolecularFormula("C43H50CoN4O16", builder);
        formula.setCharge(0);
