...
/**
 * This class validate if the Isotope Pattern from a given IMolecularFormula correspond with other
 * to compare.
 *
 * <table border="1">
...
public class IsotopePatternRule implements IRule {
    ...
    /**
     * Validate the isotope pattern of this IMolecularFormula. Important, first you have to add with
     * the {@link #setParameters(Object[])} a IMolecularFormulaSet which represents the isotope
     * pattern to compare.
     *
