...
public class MolecularFormulaGenerator {
    ...
    /**
     * Generates a IMolecularFormulaSet by repeatedly calling getNextFormula()
     * until all possible formulas are generated. There is no guaranteed order
     * to the formulas in the resulting IMolecularFormulaSet.
     * 
     * Note: if some formulas were already generated by calling getNextFormula()
     * on this MolecularFormulaGenerator instance, those formulas will not be
     * included in the returned IMolecularFormulaSet.
     * 
     * @see getNextFormula()
     */
     ...
     * the first call to getNextFormula(), this method returns 0. After all
     * possible formulas are generated, this method returns 1.0 (the exact
     ...
     * another thread is executing the getNextFormula() method, that method call
     * will return immediately with null return value. If another thread is
     * executing the getAllFormulas() method, that method call will return
     * immediately, returning all formulas generated until this moment. The
     * search cannot be restarted once canceled - any subsequent calls to
     * getNextFormula() will return null.
     */
    ...
    /**
     * A simple Comparator implementation for sorting IIsotopes by their mass
     */
