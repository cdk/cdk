...
public final class SmiFlavor {
    ...
    /**
     * Output SMILES in a canonical order. The order is not guaranteed to be equivalent between
     * releases.
     */
    ...
    /**
     * Output atom-atom mapping for reactions and atom classes for molecules. The map index is set
     * on an atom with property {@link org.openscience.cdk.CDKConstants#ATOM_ATOM_MAPPING} using
     * {@link org.openscience.cdk.interfaces.IAtom#setProperty(Object, Object)}.
     */
    public static final int AtomAtomMap = 0x004;

    /**
     * Output atomic mass on atoms. For historical reasons the atomic mass is often set on all atoms
     * in a CDK molecule. Therefore to avoid SMILES like {@code [12CH3][12CH2][16OH]} major isotopes
     * are not generated. If you wish to generate SMILES with the major isotopes please use the flag
     * {@link #AtomicMassStrict} this will output all mass numbers and only be omitted when the mass
     * is unset (null).
     */
    ...
    /**
     * Output cis-trans stereochemistry specified by directional <code>\</code> of <code>/</code>
     * bonds.
     *
     * @see #Stereo
     */
    ...
    /**
     * Output extended tetrahedral stereochemistry on atoms as <code>@</code> and <code>@@</code>.
     * Extended tetrahedral captures rotations around a cumulated carbon: <code>CC=[C@]=CC</code>.
     *
     * @see #Stereo
     */
     ...
     *
     * @deprecated no longer needed, default CDK behaviour is now to pass through mass numbers if
     *     non-null
     */
    @Deprecated public static final int AtomicMassStrict = 0x800;
    ...
    public static final int Stereo =
            StereoTetrahedral | StereoCisTrans | StereoExTetrahedral | StereoExCisTrans;
    ...
    /**
     * Output atom values, atom values are specified by the property {@link
     * org.openscience.cdk.CDKConstants#COMMENT} using {@link
     * org.openscience.cdk.interfaces.IAtom#setProperty(Object, Object)}
     */
    public static final int CxAtomValue = 0x010000;

    /**
     * Output radicals, radicals are specified by {@link
     * IAtomContainer#getConnectedSingleElectronsCount(IAtom)}
     */
    public static final int CxRadical = 0x020000;

    /**
     * Output multicenter bonds, positional variation is specified with {@link
     * org.openscience.cdk.sgroup.Sgroup}s of the type {@link
     * org.openscience.cdk.sgroup.SgroupType#ExtMulticenter}.
     */
    ...
    /**
     * Default SMILES output write Stereochemistry, Atomic Mass, and CXSMILES layers. The ordering
     * is not canonical.
     */
    public static final int Default = Stereo | AtomicMass | CxSmiles;

    /**
     * Output canonical SMILES with stereochemistry and atomic masses, This output uses the InChI
     * labelling algorithm to generate a 'Universal SMILES' {@cdk.cite OBoyle12}. <br>
     * Unfortunately there are several issues and general use is not recommended:
     *
     * <ul>
     *   <li>MAJOR: Molecules with delocalised charges are generally non-canonical, e.g. <code>
     *       C(\C=C\N1CCCC1)=C/c2[n+](c3c(n2CC)nc4ccccc4n3)CC</code> will generate two different
     *       SMILES depending on input order
     *   <li>MINOR: Double bond '/' '\' assignment is different from the original paper (O'Boyle)
     *       and will not match universal SMILES generated by Open Babel
     ...
     *       providing there are no '*' atoms.
     *   <li>MINOR: The InChI library (v1.03) is not thread safe
     * </ul>
     */
