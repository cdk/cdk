...
/**
 * Writes a reaction to a MDL rxn or SDF file. Attention: Stoichiometric coefficients have to be
 * natural numbers.
 *
 * <pre>
...
public class MDLRXNWriter extends DefaultChemObjectWriter {
    ...
    /**
     * Here you can set a map which will be used to build rd fields in the file. The entries will be
     * translated to rd fields like this:<br>
     * &gt; &lt;key&gt;<br>
     * &gt; value<br>
     * empty line<br>
     *
    ...
    /**
     * Writes a IChemObject to the MDL RXN file formated output. It can only output ChemObjects of
     * type Reaction
     *
    ...
    private void writeReaction(IReaction reaction) throws CDKException {
        ...
        try {
            ...
            // we do not write such a sign at the end of the first reaction, thus we have to write
            // on BEFORE the second reaction
            if (reactionNumber == 2) {
                writer.write("$$$$");
                writer.write('\n');
            }
            ...
            if (agentCount > 0 && writeAgents.isSet()) line += formatMDLInt(agentCount, 3);
            writer.write(line);
            writer.write('\n');
            ...
            if (agentCount > 0 && writeAgents.isSet()) writeAtomContainerSet(reaction.getAgents());
            ...
            for (int j = 0; j < som.getMultiplier(i); j++) {
                ...
                try {
                    ...
                    throw new CDKException(
                            "Exception while creating MDLWriter: " + ex.getMessage(), ex);
                }
                mdlwriter.write(mol);
                mdlwriter.close();
