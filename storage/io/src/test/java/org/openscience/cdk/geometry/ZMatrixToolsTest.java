...
public class ZMatrixToolsTest extends CDKTestCase {
    ...
    @Test
    public void
            testZmatrixToCartesian_arraydouble_arrayint_arraydouble_arrayint_arraydouble_arrayint() {
        ...
        Point3d points[] =
                ZMatrixTools.zmatrixToCartesian(
                        distances, first_atoms, angles, second_atoms, dihedrals, third_atoms);
