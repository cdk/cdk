...
public class Mol2ReaderTest extends SimpleChemObjectReaderTest {
    ...
    /**
     * Test example from website. See <a
     * href="http://www.tripos.com/custResources/mol2Files/mol2_format3.html">Tripos example</a>.
     */
    @Test
    ...
    public void testNCIfeb03_2D() throws Exception {
        ...
        InputStream in =
                new GZIPInputStream(
                        Mol2ReaderTest.class.getClassLoader().getResourceAsStream(filename));
    ...
    private void checkMol(StringBuilder buf) throws Exception {
        ...
        Assert.assertTrue(
                mol.getChemSequence(0).getChemModel(0).getMoleculeSet().getAtomContainerCount()
                        > 0);
        Assert.assertTrue(
                mol.getChemSequence(0)
                                .getChemModel(0)
                                .getMoleculeSet()
                                .getAtomContainer(0)
                                .getAtomCount()
    ...
    public void unrecognisedAtomTypes() throws Exception {
        ...
        try {
            ...
            for (IAtom atom : container.atoms()) Assert.assertNotNull(atom.getAtomicNumber());
        } finally {
