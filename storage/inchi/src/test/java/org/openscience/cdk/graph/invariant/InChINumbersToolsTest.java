...
public class InChINumbersToolsTest extends CDKTestCase {
    ...
    public void parseStandard() throws Exception {
        assertThat(
                InChINumbersTools.parseUSmilesNumbers(
                        "AuxInfo=1/0/N:3,2,1/rA:3OCC/rB:s1;s2;/rC:;;;", mock(3)),
                is(new long[] {3, 2, 1}));
    }
    ...
    public void favorCarbonyl() throws Exception {
        IAtomContainer container =
                new SmilesParser(SilentChemObjectBuilder.getInstance()).parseSmiles("P([O-])=O");
    ...
    public void bug1370() throws Exception {
        IAtomContainer container =
                new SmilesParser(SilentChemObjectBuilder.getInstance()).parseSmiles("O=[Bi]Cl");
    ...
    public void protons() throws Exception {
        ...
        assertThat(
                InChINumbersTools.getUSmilesNumbers(container),
                is(new long[] {8, 9, 1, 7, 2, 3, 4, 5, 6}));
    }
