...
final class InChIOutputToStructure {
  ...
  InChIOutputToStructure() {}

  /**
   * Gets the structure from InChI and returns the InChI lib data structure converted into an IAtomContainer.
   *
   * @return IAtomContainer
   * @throws CDKException
   */
  static IAtomContainer generateAtomContainerFromInChIOutput(InchiInputFromInchiOutput output, IChemObjectBuilder builder)
          throws CDKException {
    return generateAtomContainerFromInChIInput(output.getInchiInput(), builder);
  }

  /**
   * Gets the structure from AuxInfo of InChI and returns the InChI lib data structure converted into an IAtomContainer.
   *
   * @return IAtomContainer
   * @throws CDKException
   */
