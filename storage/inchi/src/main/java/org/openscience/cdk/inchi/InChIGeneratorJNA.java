 ...
 * @cdk.githash
 */
public class InChIGenerator  extends InChIGeneratorAbs {

	protected InChIGenerator(IAtomContainer container, boolean ignoreAromaticBonds) throws CDKException {
		super(container, ignoreAromaticBonds);
	}

	protected InChIGenerator(IAtomContainer container, InchiOptions options, boolean ignoreAromaticBonds) throws CDKException {
	 ...
	 * @author Bob Hanson
	 */
    protected InChIGenerator(IAtomContainer container, String options, boolean ignoreAromaticBonds) throws CDKException {
		super(container, options, ignoreAromaticBonds);
	}

	@SuppressWarnings("deprecation")
	protected InChIGenerator(IAtomContainer container, List<INCHI_OPTION> options, boolean ignoreAromaticBonds) throws CDKException {
		super(container, options, ignoreAromaticBonds);
	}
    ...
    private static final ILoggingTool LOGGER = LoggingToolFactory.createLoggingTool(InChIGeneratorAbs.class);
     ...
     */
    @Override
	protected void generateInchiFromCDKAtomContainer(IAtomContainer atomContainer, 
			boolean ignore) throws CDKException {
