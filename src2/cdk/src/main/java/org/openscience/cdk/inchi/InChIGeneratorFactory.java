...
public class InChIGeneratorFactory {
    ...
    public InChIGenerator getInChIGenerator(IAtomContainer container) throws CDKException {
        return getInChIGenerator(container, (String) null);
    }
    ...
    public InChIGenerator getInChIGenerator(IAtomContainer container, String options) throws CDKException {
        return (newInChIGenerator(container, options));
    }
    ...
    public InChIToStructure getInChIToStructure(String inchi, IChemObjectBuilder builder) throws CDKException {
        return (newInChIToStructure(inchi, builder));
    }
    ...
    public InChIToStructure getInChIToStructure(String inchi, IChemObjectBuilder builder, String options)
            throws CDKException {
        return (newInChIToStructure(inchi, builder, options));
    }
    ...
    // added for platform-specific implementations in SwingJS
	 ...
	 */
	private static InChIGenerator getSwingJSInChIGeneratorImpl() {
		return (isJS ? new InChIGeneratorJS() : new InChIGeneratorJNA());
	}

    private InChIToStructure getSwingJSInChIToStructureImpl() {
	...
	private InChIGenerator newInChIGenerator(IAtomContainer container, String options) throws CDKException {
		return getSwingJSInChIGeneratorImpl().set(container, options, ignoreAromaticBonds);
	}

	private InChIGenerator newInChIGenerator(IAtomContainer container, List<INCHI_OPTION> options) throws CDKException {
		return getSwingJSInChIGeneratorImpl().set(container, options, ignoreAromaticBonds);
	}

    private InChIGenerator newInChIGenerator(IAtomContainer container, InchiOptions options) throws CDKException {
		return getSwingJSInChIGeneratorImpl().set(container, options, ignoreAromaticBonds);
	}

    private InChIToStructure newInChIToStructure(String inchi, IChemObjectBuilder builder) throws CDKException {
		return getSwingJSInChIToStructureImpl().set(inchi, builder);
	}


	private InChIToStructure newInChIToStructure(String inchi, IChemObjectBuilder builder, String options) throws CDKException {
		return getSwingJSInChIToStructureImpl().set(inchi, builder, options);
	}

    private InChIToStructure newInChIToStructure(String inchi, IChemObjectBuilder builder, List<String> options) throws CDKException {
		return getSwingJSInChIToStructureImpl().set(inchi, builder, options);
	}
