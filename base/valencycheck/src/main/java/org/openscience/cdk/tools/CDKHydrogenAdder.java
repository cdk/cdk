...
/**
 * Adds implicit hydrogens based on atom type definitions. The class assumes that CDK atom types are
 * already detected. A full code example is:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>If you want to add the hydrogens to a specific atom only, use this example:
 *
 * <pre>
...
public class CDKHydrogenAdder {
    ...
    private static Map<String, CDKHydrogenAdder> tables =
            new Hashtable<String, CDKHydrogenAdder>(3);
    ...
    /**
     * Sets the implicit hydrogen count for the indicated IAtom in the given IAtomContainer. If the
     * atom type is "X", then the atom is assigned zero implicit hydrogens.
     *
     * @param container The molecule to which H's will be added
    ...
    public void addImplicitHydrogens(IAtomContainer container, IAtom atom) throws CDKException {
        ...
        atom.setImplicitHydrogenCount(
                type.getFormalNeighbourCount() - container.getConnectedBondsCount(atom));
    }
}
