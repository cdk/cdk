...
public class SharingChargeDBReactionTest extends ReactionProcessTest {
    ...
    /**
     * A unit test suite for JUnit. Reaction: C-C=[O+] => C-[C+]O| Automatic search of the center
     * active.
     *
    ...
    /**
     * A unit test suite for JUnit. Reaction: C-C=[O+] => C-[C+]O| Manually put of the center
     * active.
     *
     * @return The test suite
     */
