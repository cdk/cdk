...
public class ReactionSpecificationTest extends CDKTestCase {
    ...
    private static final String REAC_REF = "bla";
    private static final String REAC_IMPL_TITLE = "bla2";
    private static final String REAC_IMPL_VENDOR = "bla3";
    private static final String REAC_IMPL_ID = "bla4";

    @Test
    public void testReactionSpecification_String_String_String_String() {
        ReactionSpecification spec =
