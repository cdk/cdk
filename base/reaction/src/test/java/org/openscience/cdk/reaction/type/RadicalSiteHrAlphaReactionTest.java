...
public class RadicalSiteHrAlphaReactionTest extends ReactionProcessTest {
    ...
    /**
     * A unit test suite for JUnit. Reaction: Automatic search of the center active.
     *
        ...
        IAtom mappedProductA1 =
                (IAtom)
                        ReactionManipulator.getMappedChemObject(
                                setOfReactions.getReaction(2), molecule.getAtom(0));
        Assert.assertEquals(mappedProductA1, product.getAtom(0));
        IAtom mappedProductA2 =
                (IAtom)
                        ReactionManipulator.getMappedChemObject(
                                setOfReactions.getReaction(2), molecule.getAtom(6));
        Assert.assertEquals(mappedProductA2, product.getAtom(6));
        IAtom mappedProductA3 =
                (IAtom)
                        ReactionManipulator.getMappedChemObject(
                                setOfReactions.getReaction(2), molecule.getAtom(2));
