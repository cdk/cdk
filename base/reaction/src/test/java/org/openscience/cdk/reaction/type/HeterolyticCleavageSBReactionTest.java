...
/**
 * TestSuite that runs a test for the HeterolyticCleavageSBReactionTest. Generalized Reaction: A-B
 * => |[A-] +[B+] // [A+] + |[B-]. Depending on the bond order the bond will be removed or simply
 * the order decreased.
 *
...
public class HeterolyticCleavageSBReactionTest extends ReactionProcessTest {
    ...
    /**
     * A unit test suite for JUnit. Reaction: propane. CC!-!C => C[C+] + [C-] C[C-] + [C+]
     *
    ...
    /**
     * A unit test suite for JUnit. Reaction: . C[C+]!-!C => CC + [C+]
     *
     * @return The test suite
     */
    @Test
    ...
    /**
     * A unit test suite for JUnit. Reaction: Propene. C=C!-!C => C=[C+] + [C-] C=[C-] + [C+]
     *
    ...
    /**
     * A unit test suite for JUnit. Reaction: Propyne. C#C!-!C => C#[C+] + [C-] C#[C-] + [C+]
     *
    ...
    /**
     * A unit test suite for JUnit. Reaction: C-O => [C+] + [O-] Manually put of the reactive
     * center.
     *
    ...
    /**
     * A unit test suite for JUnit. Reaction: C-O => [C+] + [O-] Test of mapped between the reactant
     * and product. Only is mapped the reactive center.
     *
     * @cdk.inchi InChI=1/CH4O/c1-2/h2H,1H3
     * @return The test suite
     */
