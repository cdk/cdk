...
public class RadicalSiteRrGammaReactionTest extends ReactionProcessTest {
    ...
    void testCDKConstants_REACTIVE_CENTER() throws Exception {
        ...
        Assertions.assertTrue(molecule.getAtom(5).getFlag(CDKConstants.REACTIVE_CENTER));
        Assertions.assertTrue(reactant.getAtom(5).getFlag(CDKConstants.REACTIVE_CENTER));
