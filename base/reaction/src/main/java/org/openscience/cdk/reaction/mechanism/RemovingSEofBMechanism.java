...
/**
 * This mechanism extracts a single electron from a bonding orbital which located in an bond. It
 * could have single, double as triple order. It returns the reaction mechanism which has been
 * cloned the {@link IAtomContainer} with a decrease of the order of the bond and a ISingleElectron
 * more.
 *
...
public class RemovingSEofBMechanism implements IReactionMechanism {
     ...
     *     first atom receives the charge and the second the single electron
    ...
    public IReaction initiate(
        ...
        reactantCloned.addSingleElectron(
                atom1C.getBuilder().newInstance(ISingleElectron.class, atom2C));
