...
/**
 * HyperconjugationReaction is the stabilizing interaction that results from the interaction of the
 * electrons in a s-bond (for our case only C-H) with an adjacent empty (or partially filled)
 * p-orbital.
 *
 * <p>Based on the valence bond model of bonding, hyperconjugation can be described as "double bond
 * - no bond resonance"
 *
 * <p>This reaction could be represented like
 *
 * <pre>[C+]-C =&gt; C=C + [H+] </pre>
 *
 * <pre>
