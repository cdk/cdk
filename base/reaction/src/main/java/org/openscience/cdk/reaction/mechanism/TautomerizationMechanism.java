...
/**
 * This mechanism produces the tautomerization chemical reaction between two tautomers. It returns
 * the reaction mechanism which has been cloned the {@link IAtomContainer}.
 *
 * <p>This reaction could be represented as X=Y-Z-H =&gt; X(H)-Y=Z
 *
...
public class TautomerizationMechanism implements IReactionMechanism {
    ...
    /**
     * Initiates the process for the given mechanism. The atoms and bonds to apply are mapped
     ...
     *     first bond is the bond to decrease the order and the second is the bond to increase the
    ...
    public IReaction initiate(
        ...
        IBond newBond =
                molecule.getBuilder().newInstance(IBond.class, atom1C, atom4C, IBond.Order.SINGLE);
