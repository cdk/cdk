 ...
 *   <li><code>[C5H5]-</code>
 *   <li><code>C6H6</code>
 *   <li><sup>12</sup>C<sub>5</sub><sup>13</sup>CH<sub>6</sub>
 * </ul>
 *
...
public interface IMolecularFormula extends ICDKObject {
    ...
    /**
     * Checks a set of Nodes for the occurrence of the isotope in the IMolecularFormula from a
     * particular isotope. It returns 0 if the does not exist.
     *
    ...
    /**
     * True, if the MolecularFormula contains the given IIsotope object. Not the instance. The
     * method looks for other isotopes which has the same symbol, natural abundance and exact mass.
     *
    ...
    /**
     * Sets the charge of this IMolecularFormula, since there is no atom associated with the charge
     * the number of a given isotope is not modified.
     *
     * <pre>
     * // Correct usage
    ...
    /**
     * Access the charge of this IMolecularFormula. If the charge has not been set the return value
     * is null.
     *
