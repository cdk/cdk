...
/**
 * The base class for all chemical objects in this cdk. It provides methods for adding listeners and
 * for their notification of events, as well a a hash table for administration of physical or
 * chemical properties
 *
 * @author egonw
 * @cdk.githash
...
public interface IChemObject extends ICDKObject {
    ...
    /**
     * Returns a property for the IChemObject - the object is automatically cast to the required
     * type. This does however mean if the wrong type is provided then a runtime ClassCastException
     * will be thrown.
     *
     * <pre>{@code
     ...
     * @return The object containing the property. Returns null if property is not set.
     * @see #setProperty
    ...
    /**
     * Sets the value of some flag. The flag is a mask from a given CDKConstant (e.g. {@link
     * org.openscience.cdk.CDKConstants#ISAROMATIC} or {@link
     * org.openscience.cdk.CDKConstants#VISITED}). The flags are intrinsic internal properties and
     * should not be used to store custom values, please use {@link #setProperty(Object, Object)}.
     *
     * <pre>{@code
    ...
    /**
     * Returns the value of a given flag. The flag is a mask from a given CDKConstant (e.g. {@link
     * org.openscience.cdk.CDKConstants#ISAROMATIC}).
     *
     * <pre>{@code
    ...
    /**
     * Set the properties of this object to the provided map (shallow copy). Any existing properties
     * are removed.
     *
    ...
    /**
     * Sets the whole set of flags. This set will iteratively invoke {@link #setFlag(int, boolean)}
     * for each value in the array and use {@link org.openscience.cdk.CDKConstants#FLAG_MASKS} to
     * look up the correct mask. If only a single flag is being set it is a lot faster to use {@link
     * #setFlag(int, boolean)}.
     *
    ...
    /**
     * Returns the whole set of flags. This method will create a new array on each invocation and it
     * is recommend you use {@link #getFlagValue()} if you need all the flags. For individual flags
     * please use {@link #getFlag(int)}
     *
     * @return the flags.
     * @see #setFlags
     * @see #getFlag(int)
    ...
    /**
     * Access the internal value used to store the flags. The flags are stored on a single numeric
     * value and are set/cleared.
     *
