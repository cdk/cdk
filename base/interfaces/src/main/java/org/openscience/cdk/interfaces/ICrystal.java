...
/**
 * Class representing a molecular crystal. The crystal is described with molecules in fractional
 * coordinates and three cell axes: a,b and c.
 *
 * <p>The crystal is designed to store only the asymetric atoms. Though this is not enforced, it is
 * assumed by all methods.
 *
...
public interface ICrystal extends IAtomContainer {
    ...
    /**
     * Adds the atoms in the AtomContainer as cell content. Symmetry related atoms should not be
     * added unless P1 space group is used.
     *
    ...
    /**
     * Adds the atom to the crystal. Symmetry related atoms should not be added unless P1 space
     * group is used.
     *
