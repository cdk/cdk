...
/**
 * Interface definition for Rgroup query classes. These must provide a root structure, root
 * attachment points and Rgroup definitions.
 *
...
public interface IRGroupQuery extends IChemObject {
     ...
     * @param rootAttachmentPoints Map with per R-group pseudo atom another map with an Integer and
     *     an IBond, the integer indicating 1st or 2nd attachment.
     */
     ...
     * @return Map with per R-group pseudo atom another map with an Integer and an IBond, the
     *     integer indicating 1st or 2nd attachment.
     */
     ...
     * @param rGroupDefinitions map with an Integer and an RGroupList (substituent list), the
     *     Integer being the R-Group number (1..32).
     */
     ...
     * @return rGroupDefinitions Map with an Integer and an RGroupList (substituent list), the
     *     Integer being the R-Group number (1..32).
     */
    ...
    /**
     * Return all the substituent atom containers, in other words the atom containers defined in
     * this RGroupQuery except for the root structure.
     *
    ...
    /**
     * Checks validity of the RGroupQuery. Each distinct R# in the root must have a a corresponding
     * {@link RGroupList} definition.<br>
    ...
    /**
     * Checks validity of RGroupQuery. Each {@link RGroupList} definition must have one or more
     * corresponding R# atoms in the root block.
     *
     * @return true when valid
     */
    ...
    /**
     * Produces all combinations of the root structure (scaffold) with the R-groups substituted in
     * valid ways, using each R-group's definitions and conditions.
     *
     * @return all valid combinations of the root structure (scaffold) with the R-groups
     *     substituted.
     * @throws Exception
     */
