...
/**
 * Vento-Foggia (VF) state for matching isomorphisms (identity) {@cdk.cite Cordella04}. Note: no
 * heuristics or sorting are performed as all and should be checked externally
 *
 * @author John May
...
final class VFState extends AbstractVFState {
    ...
    /** The query (container1) and target (container2) of the isomorphism matching. */
    private final IAtomContainer container1, container2;

    /**
     * Lookup for the query bonds (bonds1) and target bonds (bonds2) of the isomorphism matching.
     */
    ...
    /**
     * Create a VF state for matching isomorphisms. The query is passed first and should read as,
     * find container1 in container2.
     *
     ...
     * vertex (terminal) then the number of such edges should be equal in g1 compared to g2
     * (1-look-ahead). If the edge is unmapped and non-terminal then the number of such edges should
     * be equal in g1 compared to g2 (2-look-ahead).
     *
