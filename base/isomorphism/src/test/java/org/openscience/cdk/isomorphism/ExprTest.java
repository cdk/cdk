...
public class ExprTest {
    ...
    public void testNotStereo3() {
        Expr expr =
                new Expr(NOT, new Expr(STEREOCHEMISTRY, 1).or(new Expr(STEREOCHEMISTRY, 0)), null);
        IAtom atom = mock(IAtom.class);
        assertTrue(expr.matches(atom));
        assertTrue(expr.matches(atom, 2));
        assertFalse(expr.matches(atom, 1));
    ...
    public void testGroupT() {
        Expr expr = new Expr(PERIODIC_GROUP, Elements.Chlorine.group());
        IAtom atom = mock(IAtom.class);
    ...
    public void testHybridisation0F() {
        Expr expr = new Expr(HYBRIDISATION_NUMBER, 0);
        IAtom atom = mock(IAtom.class);
    ...
    public void testHybridisationSp1T() {
        Expr expr = new Expr(HYBRIDISATION_NUMBER, 1);
        IAtom atom = mock(IAtom.class);
        when(atom.getHybridization()).thenReturn(IAtomType.Hybridization.SP1);
        assertTrue(expr.matches(atom));
    }
    ...
    public void testHybridisationSp2T() {
        Expr expr = new Expr(HYBRIDISATION_NUMBER, 2);
        IAtom atom = mock(IAtom.class);
        when(atom.getHybridization()).thenReturn(IAtomType.Hybridization.SP2);
        assertTrue(expr.matches(atom));
    }
    ...
    public void testHybridisationSp3T() {
        Expr expr = new Expr(HYBRIDISATION_NUMBER, 3);
        IAtom atom = mock(IAtom.class);
    ...
    public void testHybridisationSp3d1T() {
        Expr expr = new Expr(HYBRIDISATION_NUMBER, 4);
        IAtom atom = mock(IAtom.class);
    ...
    public void testHybridisationSp3d2T() {
        Expr expr = new Expr(HYBRIDISATION_NUMBER, 5);
        IAtom atom = mock(IAtom.class);
    ...
    public void testHybridisationSp3d3T() {
        Expr expr = new Expr(HYBRIDISATION_NUMBER, 6);
        IAtom atom = mock(IAtom.class);
    ...
    public void testHybridisationSp3d4T() {
        Expr expr = new Expr(HYBRIDISATION_NUMBER, 7);
        IAtom atom = mock(IAtom.class);
    ...
    public void testHybridisationSp3d5T() {
        Expr expr = new Expr(HYBRIDISATION_NUMBER, 8);
        IAtom atom = mock(IAtom.class);
    ...
    public void testReactionRoleT() {
        Expr expr = new Expr(REACTION_ROLE, ReactionRole.Reactant.ordinal());
        IAtom atom = mock(IAtom.class);
    ...
    public void testRingSmallestSize5And6() {
        ...
        for (IAtom atom : mol.atoms()) {
            if (expr5.matches(atom)) numSmall5++;
            if (expr6.matches(atom)) numSmall6++;
        }
    ...
    public void testToString() {
        ...
        assertThat(
                new Expr(ELEMENT, 8).or(new Expr(DEGREE, 3)).toString(),
                is("OR(ELEMENT=8,DEGREE=3)"));
        assertThat(
                new Expr(ELEMENT, 8).and(new Expr(DEGREE, 3)).toString(),
                is("AND(ELEMENT=8,DEGREE=3)"));
    ...
    public void testNegationOptimizations() {
        ...
        assertThat(new Expr(ELEMENT, 8).negate(), is(new Expr(NOT, new Expr(ELEMENT, 8), null)));
        assertThat(new Expr(NOT, new Expr(ELEMENT, 8), null).negate(), is(new Expr(ELEMENT, 8)));
        assertThat(new Expr(HAS_UNSPEC_ISOTOPE).negate(), is(new Expr(HAS_ISOTOPE)));
        assertThat(new Expr(HAS_ISOTOPE).negate(), is(new Expr(HAS_UNSPEC_ISOTOPE)));
    }
    ...
    public void alwaysTrueAnd() {
        assertThat(new Expr(TRUE).and(new Expr(TRUE)), is(new Expr(TRUE)));
    }

    @Test
    public void alwaysFalseAnd() {
        assertThat(new Expr(FALSE).and(new Expr(TRUE)), is(new Expr(FALSE)));
    }

    @Test
    public void removeFalseOr() {
        assertThat(new Expr(DEGREE, 2).or(new Expr(FALSE)), is(new Expr(DEGREE, 2)));
        assertThat(new Expr(DEGREE, 2).or(new Expr(TRUE)), is(new Expr(DEGREE, 2)));
        assertThat(new Expr(FALSE).or(new Expr(DEGREE, 2)), is(new Expr(DEGREE, 2)));
        assertThat(new Expr(TRUE).or(new Expr(DEGREE, 2)), is(new Expr(DEGREE, 2)));
    }
}
