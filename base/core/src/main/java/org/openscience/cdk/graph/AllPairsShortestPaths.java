...
public final class AllPairsShortestPaths {
    ...
    /**
     * an empty atom container so we can handle invalid vertices/atoms better. Not very pretty but
     * we can't access the domain model from cdk-core.
     */
    private static final IAtomContainer EMPTY_CONTAINER =
            new IAtomContainer() {
    ...
    /**
     * pseudo shortest-paths - when an invalid atom is given. this will always return 0 length paths
     * and distances.
     */
    private static final ShortestPaths EMPTY_SHORTEST_PATHS =
            new ShortestPaths(new int[0][0], EMPTY_CONTAINER, 0);
}
