...
public class FischerRecognitionTest {
    ...
    public void recogniseRightHandedGlyceraldehyde() throws Exception {
        ...
        FischerRecognition recogniser =
                new FischerRecognition(m, graph, bondMap, Stereocenters.of(m));
        List<IStereoElement> elements =
                recogniser.recognise(Collections.singleton(Projection.Fischer));
    ...
    public void obtainCardinalBonds() {
        ...
        IBond[] actual =
                FischerRecognition.cardinalBonds(
                        focus, new IBond[] {expected[1], expected[2], expected[3], expected[0]});
        org.hamcrest.MatcherAssert.assertThat(expected, is(actual));
    }

    /**
     * In reality, bonds may not be perfectly orthogonal. Here the N, E, S, and W atoms are all
     * slightly offset from the focus.
     */
    @Test
    ...
    public void createCenterWithThreeNeighbors_right() {
        ...
        IBond[] bonds =
                new IBond[] {new Bond(focus, south), new Bond(focus, north), new Bond(focus, east)};
    ...
    public void createCenterWithThreeNeighbors_left() {
        ...
        IBond[] bonds =
                new IBond[] {new Bond(focus, south), new Bond(focus, north), new Bond(focus, west)};
    ...
    public void doNotCreateCenterWhenNorthIsMissing() {
        ...
        IBond[] bonds =
                new IBond[] {new Bond(focus, south), new Bond(focus, west), new Bond(focus, east)};
    ...
    public void doNotCreateCenterWhenSouthIsMissing() {
        ...
        IBond[] bonds =
                new IBond[] {new Bond(focus, north), new Bond(focus, west), new Bond(focus, east)};
    ...
    public void doNotCreateCenterWhenEastAndWestAreMissing() {
        ...
        IBond[] bonds = new IBond[] {new Bond(focus, north), new Bond(focus, south)};
     ...
     *
     * @cdk.inchi
     *     InChI=1S/C15H20O5/c1-12(2)6-13(3)7-19-10(16)9-15(13)8(12)4-5-14(15,18)11(17)20-9/h8-9,18H,4-7H2,1-3H3/t8-,9+,13+,14+,15?/m0/s1
     */
    @Test
    public void ignoreCyclicStereocenters() {
        ...
        FischerRecognition recogniser =
                new FischerRecognition(m, graph, bondMap, Stereocenters.of(m));
        Assert.assertTrue(
                recogniser.recognise(Collections.singleton(Projection.Fischer)).isEmpty());
    }
    ...
    static void assertTetrahedralCenter(
            IStereoElement element, IAtom focus, Stereo winding, IAtom... neighbors) {
