...
class CanonTest {
    ...
    @Test
    void phenol_symmetry() throws Exception {
    ...
    @Test
    void phenol_labelling() throws Exception {
        IAtomContainer m = smi("OC1=CC=CC=C1");
    ...
    @Test
    void atomComparatorLabelling() throws Exception {
     ...
     */
    @Test
    void lenthionine_symmetry() throws Exception {
    ...
    @Test
    void testBasicInvariants_ethanol() throws Exception {
    ...
    @Test
    void testBasicInvariants_phenol() throws Exception {
        IAtomContainer m = smi("OC1=CC=CC=C1");
    ...
    @Test
    void terminalExplicitHydrogensAreNotIncluded() throws Exception {
    ...
    @Test
    void bridgingExplicitHydrogensAreIncluded() throws Exception {
    ...
    @Test
    void isotopeFlavor() throws Exception {
    ...
    @Test
    void explicitHydrogensIonsAreIncluded() throws Exception {
    ...
    @Test
    void molecularHydrogensAreNotIncluded() throws Exception {
    ...
    @Test
    void explicitHydrogensOfEthanolHaveSymmetry() throws Exception {
    ...
    @Test
    void explicitHydrogensDoNotAffectHeavySymmetry() throws Exception {
    ...
    @Test
    void canonicallyLabelEthaneWithInConsistentHydrogenRepresentation() throws Exception {
    ...
    @Test
    void canonicallyLabelEthaneWithInConsistentHydrogenRepresentation2() throws Exception {
    ...
    @Test
    void canonicallyLabelCaffeineWithExplicitHydrogenRepresentation() throws Exception {
    ...
    private static final SmilesGenerator sg = new SmilesGenerator(SmiFlavor.Isomeric | SmiFlavor.AtomAtomMap);
