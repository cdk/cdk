...
public class GeometryUtilTest extends CDKTestCase {
    ...
    @Test public void testGetClosestAtom_Double_Double_IAtomContainer_IAtom() {
        ...
        acont.addAtom(atom2);
        Assert.assertEquals(
            atom2, GeometryUtil.getClosestAtom(1.0, 0.0, acont, atom1)
        );
        Assert.assertEquals(
            atom1, GeometryUtil.getClosestAtom(1.0, 0.0, acont, null)
        );
    }
    ...
    @Test public void testGetBondLengthAverage_IReaction() {
        ...
        Assert.assertEquals(
            1.0, GeometryUtil.getBondLengthAverage(reaction), 0.0
        );
    }
    ...
    @Test public void testGetBondLengthAverage_MultiReaction() {
        ...
        Assert.assertEquals(
            2.0, GeometryUtil.getBondLengthAverage(reaction), 0.0
        );
    }
