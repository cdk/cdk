...
class CyclicCarbohydrateRecognitionTest {
    ...
    void requireAtLeastTwoProjectedSubstituents() {
        ...
        m.addBond(1, 0, IBond.Order.DOUBLE);
        m.addBond(2, 1, IBond.Order.SINGLE);
