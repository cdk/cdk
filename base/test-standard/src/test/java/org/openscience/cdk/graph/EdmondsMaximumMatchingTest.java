...
/**
 * Maximum matching is not specific to kekulisation but it serves as a good demonstration. The
 * provission of a subset to the matching inicates the atom indicies we know must be adjacent to a
 * pi bond.
 *
 * @author John May
...
public final class EdmondsMaximumMatchingTest {
    ...
    public void fullerene_C60() throws Exception {
        ...
        for (int i = 0; i < 60; i += 2) assertMatch(m, i, i + 1);
    }
    ...
    public void fullerene_C70() throws Exception {
        Matching m =
                matching(
                        "c12c3c4c5c1c1c6c7c2c2c8c3c3c9c4c4c%10c5c5c1c1c6c6c%11c%12c%13c%14c%15c%16c%17c%14c%14c%18c%13c%11c1c1c5c%10c5c(c%14c%10c%17c%11c%13c%16c%14c%16c%15c%12c%12c%16c(c2c7c6%12)c2c8c3c(c%13c%142)c2c9c4c5c%10c%112)c%181");
        assertMatch(m, 0, 1);
        assertMatch(m, 2, 3);
        assertMatch(m, 4, 5);
        assertMatch(m, 6, 7);
