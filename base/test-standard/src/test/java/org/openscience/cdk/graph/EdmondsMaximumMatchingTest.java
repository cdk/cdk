...
public final class EdmondsMaximumMatchingTest {
    ...
    @Test public void fulvelene() throws Exception {
    ...
    @Test public void acyclic() throws Exception {
    ...
    /* These two large cases show why it's benifical to seed the matching with and
     *  arbitary matching first before maximising it. All
     * matched edges are succesive. */
    ...
    @Test public void graphene() throws Exception {
