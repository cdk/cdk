...
public class DescriptorValueTest extends CDKTestCase {
    ...
    @Test
    public void
            testDescriptorValue_DescriptorSpecification_arrayString_arrayObject_IDescriptorResult_arrayString() {
    ...
    public void testGetValue() {
        ...
        DescriptorValue value =
                new DescriptorValue(
                        spec, new String[0], new Object[0], doubleVal, new String[] {"bla"});
    ...
    public void testGetException() {
        ...
        org.hamcrest.MatcherAssert.assertThat(
                value.getException(), is(instanceOf(CDKException.class)));
    }
}
