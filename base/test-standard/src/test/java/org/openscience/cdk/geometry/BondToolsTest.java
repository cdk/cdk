...
public class BondToolsTest extends CDKTestCase {
    ...
    public void testIsCisTrans_IAtom_IAtom_IAtom_IAtom_IAtomContainer() throws Exception {
        ...
        Assert.assertFalse(
                BondTools.isCisTrans(
                        mol.getAtom(2), mol.getAtom(0), mol.getAtom(1), mol.getAtom(4), mol));
    }
    ...
    public void testGiveAngleBothMethods_IAtom_IAtom_IAtom_boolean() throws Exception {
        ...
        Assert.assertEquals(
                ...
                BondTools.giveAngleBothMethods(
                        mol.getAtom(0), mol.getAtom(2), mol.getAtom(3), true),
                0.2);
        Assert.assertEquals(
                2.0943946986086157,
                BondTools.giveAngleBothMethods(
                        mol.getAtom(0), mol.getAtom(2), mol.getAtom(3), false),
                0.2);
    }
    ...
    public void testGiveAngleBothMethods_Point2d_Point2d_Point2d_boolean() throws Exception {
        ...
        Assert.assertEquals(
                2.0943946986086157,
                BondTools.giveAngleBothMethods(
                        mol.getAtom(0).getPoint2d(),
                        mol.getAtom(2).getPoint2d(),
                        mol.getAtom(3).getPoint2d(),
                        true),
                0.2);
        Assert.assertEquals(
                2.0943946986086157,
    ...
    public void testGiveAngle_IAtom_IAtom_IAtom() throws Exception {
        ...
        Assert.assertEquals(
                2.0943946986086157,
                BondTools.giveAngle(mol.getAtom(0), mol.getAtom(2), mol.getAtom(3)),
                0.2);
    }
    ...
    public void testGiveAngleFromMiddle_IAtom_IAtom_IAtom() throws Exception {
        ...
        Assert.assertEquals(
                2.0943946986086157,
                BondTools.giveAngleFromMiddle(mol.getAtom(0), mol.getAtom(2), mol.getAtom(3)),
                0.2);
    }
