...
public class KekulizationTest {
    ...
    @Test public void benzeneWithExistingDoubleBond() throws Exception {
        IAtomContainer m = new AtomContainer(5, 5, 0, 0);
        m.addAtom(atom("C", 1, true));
        m.addAtom(atom("C", 1, true));
        m.addAtom(atom("C", 1, true));
    ...
    @Test public void pyrroleWithExplicitHydrogen() throws Exception {
        IAtomContainer m = new AtomContainer(5, 5, 0, 0);
    ...
    /** @cdk.inchi InChI=1S/C5H5NO/c7-6-4-2-1-3-5-6/h1-5H */
    @Test public void pyridineOxideNonChargeSeparated() throws Exception {
        IAtomContainer m = new AtomContainer(7, 7, 0, 0);
        m.addAtom(atom("O", 0, false));
        m.addAtom(atom("N", 0, true));
        m.addAtom(atom("C", 1, true));
    ...
    @Test public void furane() throws Exception {
        IAtomContainer m = new AtomContainer(5, 5, 0, 0);
     ...
     */
    @Test public void carbonAnion() throws Exception {
        IAtomContainer m = new AtomContainer(5, 5, 0, 0);
        m.addAtom(atom("C", 1, true));
        m.addAtom(atom("C", 1, true));
        m.addAtom(atom("C", 1, true));
     ...
     */
    @Test public void seleniumCation() throws Exception {
     ...
     */
    @Test public void sixValentSulphur() throws Exception {
        ...
        assertBondOrders(m, SINGLE, DOUBLE, DOUBLE, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE, SINGLE, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE, SINGLE, SINGLE, DOUBLE, SINGLE);
    }
    ...
    @Test public void biphenyl() throws Exception {
        ...
        assertBondOrders(m, DOUBLE, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE);
    }
    ...
    @Test public void fluorene() throws Exception {
        ...
        assertBondOrders(m, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE, DOUBLE, SINGLE, SINGLE);
    }

    /** @cdk.inchi InChI=1S/C5H5B/c1-2-4-6-5-3-1/h1-5H */
    @Test public void borinine() throws Exception {
        IAtomContainer m = new AtomContainer(5, 5, 0, 0);
