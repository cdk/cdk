...
/**
 * Class defining a molecular formula object. It maintains a list of list {@link IIsotope}.
 *
 * <p>Examples:
 *
 * <ul>
 *   <li><code>[C<sub>5</sub>H<sub>5</sub>]-</code>
 *   <li><code>C<sub>6</sub>H<sub>6</sub></code>
 *   <li><code><sup>12</sup>C<sub>5</sub><sup>13</sup>CH<sub>6</sub></code>
 * </ul>
 *
 * @cdk.module silent
...
public class MolecularFormula implements IMolecularFormula {
    ...
    public IMolecularFormula add(IMolecularFormula formula) {
        ...
        if (formula.getCharge() != null)
            if (charge != null) charge += formula.getCharge();
            else charge = formula.getCharge();
        return this;
    }
    ...
    /**
     * True, if the MolecularFormula contains the given IIsotope object and not the instance. The
    ...
    protected boolean isTheSame(IIsotope isotopeOne, IIsotope isotopeTwo) {
        ...
        if (!Objects.equals(isotopeOne.getMassNumber(), isotopeTwo.getMassNumber())) return false;
