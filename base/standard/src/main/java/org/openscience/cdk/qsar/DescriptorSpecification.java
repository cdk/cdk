...
public class DescriptorSpecification implements Serializable, IImplementationSpecification {
     ...
     *     format) of the descriptor, preferably referring to the original article. The format of
     *     the content is expected to be &lt;dictionaryNameSpace&gt;:&lt;entryID&gt;.
     * @param implementationTitle Title for the implementation of the descriptor for which the
     *     algorithm is given by the specification.
    ...
    /**
     * Container for specifying the type of descriptor. The specificationIdentifier is defined by
     * the CDK version.
     *
     * @param specificationReference Reference to a formal definition in a dictionary (e.g. in STMML
     *     format) of the descriptor, preferably referring to the original article. The format of
