...
public class DescriptorValue implements Serializable {
    ...
    /**
     * Construct a descriptor value object, representing the numeric values as well as parameters
     * and provenance.
     *
     * <p>This constructor should be used when there has been no error during the descriptor
     * calculation
     *
     ...
     * and provenance.
     *
     * <p>This constructor should be used when there has been an error during the descriptor
     * calculation
     *
     * @param specification The specification
     * @param parameterNames The parameter names for the descriptors
     ...
     * @param value The actual values
     * @param descriptorNames The names of the values
     * @param exception The exception object that should have been caught if an error occurred
     ...
     * indicate the names for each value. When a descriptor creates a <code>DescriptorValue</code>
     * object, it should supply an array of names equal in length to the number of descriptor
     * calculated.
     *
     * <p>In many cases, these names can be as simple as X0, X1, ..., XN where X is a prefix and 0,
     * 1, ..., N are the indices. On the other hand it is also possible to return other arbitrary
     ...
     * single element
     *
     * <p>In case a descriptor creates a <code>DescriptorValue</code> object with no names, this
    ...
    public String[] getNames() {
        if (descriptorNames == null || descriptorNames.length == 0) {
            ...
            if (value instanceof BooleanResult
                ...
                for (int i = 0; i < ndesc; i++) descriptorNames[i] = title + i;
            }
        }
