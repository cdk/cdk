...
/**
 * Class supplying useful methods to generate random numbers. This class isn't supposed to be
 * instantiated. You should use it by calling its static methods.
 *
 * @cdk.module standard
 * @cdk.githash
 */
public class RandomNumbersTool extends Random {
     ...
     * @see <a
     *     href="http://stackoverflow.com/questions/2546078/java-random-long-number-in-0-x-n-range">Random
     *     Long Number in range, Stack Overflow</a>
     */
     ...
     * @return <code>true</code> if a success was found; <code>false</code> otherwise.
     */
     ...
     * @return a random float from a Gaussian distribution with deviation <code>dev</code>.
     */
     ...
     *
     * @param dev the desired deviation.
     * @return a random double from a Gaussian distribution with deviation <code>dev</code>.
     */
     ...
     * @return a random double from an Exponential distribution with mean value <code>mean</code>.
     */
