...
/**
 * The calculation of bond-sigma Partial charge is calculated determining the difference the Partial
 * Sigma Charge on atoms A and B of a bond. Based in Gasteiger Charge.
 *
...
public class BondPartialSigmaChargeDescriptor extends AbstractBondDescriptor {
    ...
    /**
     * The method calculates the bond-sigma Partial charge of a given bond It is needed to call the
