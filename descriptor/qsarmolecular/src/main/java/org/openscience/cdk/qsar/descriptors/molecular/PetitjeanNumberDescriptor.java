...
/**
 * According to the Petitjean definition, the eccentricity of a vertex corresponds to the distance
 * from that vertex to the most remote vertex in the graph. The distance is obtained from the
 * distance matrix as the count of edges between the two vertices. If r(i) is the largest matrix
 * entry in row i of the distance matrix D, then the radius is defined as the smallest of the r(i).
 ...
 */
public class PetitjeanNumberDescriptor extends AbstractMolecularDescriptor
    ...
    public DescriptorValue calculate(IAtomContainer atomContainer) {
        ...
        return new DescriptorValue(
                ...
                getParameterNames(),
                getParameters(),
                new DoubleResult(petitjeanNumber),
                getDescriptorNames());
    }
