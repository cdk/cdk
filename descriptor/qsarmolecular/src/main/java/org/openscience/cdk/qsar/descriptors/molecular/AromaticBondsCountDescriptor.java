 ...
 */
public class AromaticBondsCountDescriptor extends AbstractMolecularDescriptor
     ...
     *
     * <p>The method take a boolean checkAromaticity: if the boolean is true, it means that
    ...
    public DescriptorValue calculate(IAtomContainer atomContainer) {
        ...
        return new DescriptorValue(
                ...
                getParameterNames(),
                getParameters(),
                new IntegerResult(aromaticBondsCount),
                getDescriptorNames());
    }
