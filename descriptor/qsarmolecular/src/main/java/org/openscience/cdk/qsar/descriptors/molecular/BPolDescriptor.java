...
/**
 * Sum of the absolute value of the difference between atomic polarizabilities of all bonded atoms
 * in the molecule (including implicit hydrogens) with polarizabilities taken from
 * http://www.sunysccc.edu/academic/mst/ptable/p-table2.htm
 *
 * <p>This descriptor assumes 2-centered bonds.
 *
...
public class BPolDescriptor extends AbstractMolecularDescriptor implements IMolecularDescriptor {
    ...
    /**
     * This method calculate the sum of the absolute value of the difference between atomic
