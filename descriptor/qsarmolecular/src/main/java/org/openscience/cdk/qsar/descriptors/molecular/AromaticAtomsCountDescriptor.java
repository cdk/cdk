 ...
 */
public class AromaticAtomsCountDescriptor extends AbstractMolecularDescriptor
     ...
     *
     * <p>The method require one parameter: if checkAromaticity is true, the method check the
     * aromaticity, if false, means that the aromaticity has already been checked
     *
    ...
    public DescriptorValue calculate(IAtomContainer atomContainer) {
        ...
        return new DescriptorValue(
                ...
                getParameterNames(),
                getParameters(),
                new IntegerResult(aromaticAtomsCount),
                getDescriptorNames());
    }
