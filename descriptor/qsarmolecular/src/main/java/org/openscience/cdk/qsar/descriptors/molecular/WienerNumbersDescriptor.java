...
/**
 * This descriptor calculates the Wiener numbers. This includes the Wiener Path number and the
 * Wiener Polarity Number. <br>
 * Further information is given in Wiener path number: half the sum of all the distance matrix
 * entries; Wiener polarity number: half the sum of all the distance matrix entries with a value of
 * 3. For more information see {@cdk.cite Wiener1947,TOD2000}.
 *
 ...
 */
public class WienerNumbersDescriptor extends AbstractMolecularDescriptor
     ...
     *
     * <p>This descriptor does not return any parameters
     *
