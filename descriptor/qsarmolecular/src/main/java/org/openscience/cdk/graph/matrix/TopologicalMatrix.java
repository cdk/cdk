...
/**
 * Calculator for a topological matrix representation of this AtomContainer. An topological matrix
 * is a matrix of quare NxN matrix, where N is the number of atoms in the AtomContainer. The element
 * i,j of the matrix is the distance between two atoms in a molecule.
 *
 * @author federico
 * @cdk.githash
