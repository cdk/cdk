...
public class XLogPDescriptorTest extends MolecularDescriptorTest {
    ...
    public void testno688() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles("O=C(O)c1[nH0]cccc1"); // xlogp training set molecule no688
    ...
    public void testno1596() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "Nc2ccc(S(=O)(=O)c1ccc(N)cc1)cc2"); // xlogp training set molecule no1596
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno1837() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        SmilesParser sp = new SmilesParser(DefaultChemObjectBuilder.getInstance());
        IAtomContainer mol =
                sp.parseSmiles("O=P(N1CC1)(N2CC2)N3CC3"); // xlogp training set molecule no1837
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno87() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "c1cc2ccc3ccc4ccc5cccc6c(c1)c2c3c4c56"); // xlogp training set molecule no87
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno1782() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "S1C2N(C(=O)C2NC(=O)C(c2ccccc2)C(=O)O)C(C(=O)O)C1(C)C"); // xlogp training
                                                                                 // set molecule
                                                                                 // no30
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno30() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        SmilesParser sp = new SmilesParser(DefaultChemObjectBuilder.getInstance());
        IAtomContainer mol =
                sp.parseSmiles("C(#Cc1ccccc1)c1ccccc1"); // xlogp training set molecule no30
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno937() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "ClCC(O)C[nH0]1c([nH0]cc1[N+](=O)[O-])C"); // xlogp training set molecule
                                                                   // no937
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno990() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        SmilesParser sp = new SmilesParser(DefaultChemObjectBuilder.getInstance());
        IAtomContainer mol =
                sp.parseSmiles("FC(F)(F)c1ccc(cc1)C(=O)N"); // xlogp training set molecule no990
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno1000() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "Clc1cccc(c1)/C=C/[N+](=O)[O-]"); // xlogp training set molecule no1000
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno1429() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        SmilesParser sp = new SmilesParser(DefaultChemObjectBuilder.getInstance());
        IAtomContainer mol =
                sp.parseSmiles("O=C(OC)CNC(=O)c1ccc(N)cc1"); // xlogp training set molecule no1429
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno1274() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "O=[N+]([O-])c1ccc(cc1)CC(N)C(=O)O"); // xlogp training set molecule no1274
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno454() throws ClassNotFoundException, CDKException, java.lang.Exception {
        // xlogp program gives a result of -0.89, because one N is classified as in ring and not as
        // amid
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "O=C1NC(=O)C=CN1C1OC(CO)C(O)C1O"); // xlogp training set molecule no454
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testno498() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        SmilesParser sp = new SmilesParser(DefaultChemObjectBuilder.getInstance());
        IAtomContainer mol =
                sp.parseSmiles("O=C1N(C)C=CC(=O)N1C"); // xlogp training set molecule no498
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void testAprindine() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "CCN(CC)CCCN(C2Cc1ccccc1C2)c3ccccc3"); // xlogp training set molecule
                                                               // Aprindine
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void test1844() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "Brc1cc(Cl)c(O[P+]([S-])(OC)OC)cc1Cl"); // xlogp training set molecule 1844
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void test1810() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "Clc1ccc2Sc3ccccc3N(CCCN3CCN(C)CC3)c2c1"); // xlogp training set molecule
                                                                   // 1810
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
    ...
    public void test1822() throws ClassNotFoundException, CDKException, java.lang.Exception {
        ...
        IAtomContainer mol =
                sp.parseSmiles(
                        "[S+]([O-])(CCC1C(=O)N(N(c2ccccc2)C1=O)c1ccccc1)c1ccccc1"); // xlogp
                                                                                    // training set
                                                                                    // molecule 1822
        assertAtomTypesPerceived(mol);
        addExplicitHydrogens(mol);
