 ...
 */
public class PiElectronegativityDescriptor extends AbstractAtomicDescriptor
    ...
    /**
     * The method calculates the pi electronegativity of a given atom It is needed to call the
    ...
    public DescriptorValue calculate(IAtom atom, IAtomContainer atomContainer) {
        ...
        if (maxResonStruc != -1 && maxResonStruc != 0)
            electronegativity.setMaxResonStruc(maxResonStruc);
