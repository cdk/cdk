...
/**
 * The calculation of sigma partial charges in sigma-bonded systems of an heavy atom was made by
 * Marsilli-Gasteiger. It is implemented with the Partial Equalization of Orbital Electronegativity
 * (PEOE).
 *
            ...
            try {
                ...
                for (int i = 0; i < ac.getAtomCount(); i++) {
                    ...
                    cacheDescriptorValue(
                            ac.getAtom(i), ac, new DoubleResult(mol.getAtom(i).getCharge()));
                }
            } catch (Exception e) {
