...
/**
 * The calculation of total partial charges of an heavy atom is based on Partial Equalization of
 * Electronegativity method (PEOE-PEPE) from Gasteiger.
 *
 * <p>They are obtained by summation of the results of the calculations on sigma- and pi-charges.
 *
...
public class PartialTChargePEOEDescriptor extends AbstractAtomicDescriptor {
    ...
    /**
     * The method returns partial total charges assigned to an heavy atom through PEOE method. It is
            ...
            try {
                ...
                for (int i = 0; i < ac.getAtomCount(); i++)
                    cacheDescriptorValue(
                            ac.getAtom(i),
                            ac,
                            new DoubleResult(peoeAtom.get(i) + ac.getAtom(i).getCharge()));
