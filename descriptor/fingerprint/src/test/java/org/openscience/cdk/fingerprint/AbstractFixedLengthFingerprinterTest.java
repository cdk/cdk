...
abstract class AbstractFixedLengthFingerprinterTest extends AbstractFingerprinterTest {
    ...
    static IAtomContainer bug706786_1() throws CDKException {
        ...
        a18.setFlag(IChemObject.AROMATIC, true);
        mol.addAtom(a18);
        IAtom a19 = builder.newInstance(IAtom.class, "C");
        a19.setFlag(IChemObject.AROMATIC, true);
        mol.addAtom(a19);
        ...
        b6.setFlag(IChemObject.AROMATIC, true);
        mol.addBond(b6);
    ...
    static IAtomContainer bug934819_2() {
        ...
        mol.addAtom(a12);
        IAtom a13 = builder.newInstance(IAtom.class, "C");
        a13.setFlag(IChemObject.AROMATIC, true);
        mol.addAtom(a13);
        IAtom a14 = builder.newInstance(IAtom.class, "C");
        a14.setFlag(IChemObject.AROMATIC, true);
        mol.addAtom(a14);
        IAtom a15 = builder.newInstance(IAtom.class, "C");
        a15.setFlag(IChemObject.AROMATIC, true);
        mol.addAtom(a15);
        IAtom a16 = builder.newInstance(IAtom.class, "C");
        a16.setFlag(IChemObject.AROMATIC, true);
        mol.addAtom(a16);
        IAtom a17 = builder.newInstance(IAtom.class, "S");
        a17.setFlag(IChemObject.AROMATIC, true);
        mol.addAtom(a17);
        ...
        b10.setFlag(IChemObject.AROMATIC, true);
        mol.addBond(b10);
        ...
        b14.setFlag(IChemObject.AROMATIC, true);
        mol.addBond(b14);
        IBond b15 = builder.newInstance(IBond.class, a15, a14, IBond.Order.SINGLE);
        b15.setFlag(IChemObject.AROMATIC, true);
        mol.addBond(b15);
        IBond b16 = builder.newInstance(IBond.class, a16, a15, IBond.Order.DOUBLE);
        b16.setFlag(IChemObject.AROMATIC, true);
        mol.addBond(b16);
        IBond b17 = builder.newInstance(IBond.class, a17, a16, IBond.Order.SINGLE);
        b17.setFlag(IChemObject.AROMATIC, true);
        mol.addBond(b17);
