...
public class CircularFingerprintSmartsTest extends CDKTestCase {
    ...
    private static ILoggingTool logger =
            LoggingToolFactory.createLoggingTool(CircularFingerprintSmartsTest.class);

    public static SmilesParser parser = new SmilesParser(SilentChemObjectBuilder.getInstance());
    ...
    public void testMol4() throws Exception {
        ...
        String expectedFPSmarts[][] = {{"C(*)*"}, {"C1CC1", "C(C1)C1"}};
    ...
    public void testMol5() throws Exception {
        ...
        String expectedFPSmarts[][] = {
            {"C(*)*"}, {"C(C*)C*", "C(CC*)*", "C(*)CC*"}, {"C1CCC1", "C(CC1)C1", "C(C1)CC1"}
        };
        checkFPSmartsForMolecule(molSmiles, expectedFPSmarts);
    }
    ...
    public void testMol7() throws Exception {
        ...
        String expectedFPSmarts[][] = {
            ...
            {"c(a)cccca", "c(ca)ccca", "c(cca)cca", "c(ccca)ca", "c(cccca)a"},
    ...
    private void checkFPSmartsForMolecule(String moleculeSmiles, String expectedFPSmarts[][])
        ...
        for (String[] strs : expectedFPSmarts) Collections.addAll(expected, strs);
