 ...
 *
 * <p><b>References</b>: <br>
 * This test class complies the <a href="http://www.hacknot.info/hacknot/action/showEntry?eid=17">
...
public class GamessReaderTest extends SimpleChemObjectReaderTest {
     ...
     * Sets up the fixture.
     *
     * <p>This method is called before a test is executed and performs the following actions:
     *
     * <ul>
     *   <li>Constructs a new FileReader.
     *   <li>Constructs a new BufferedReader.
     *   <li>Constructs a new GamessReader.
     * </ul>
     *
     * @throws Exception may be thrown by the <code>super.setUp()</code> instruction.
     * @throws FileNotFoundException may be thrown by the "FileReader" object if the string given in
     *     parameter does not contain a valid file name.
     ...
     *
     * <ul>
     *   <li><code>imputreader</code> is not null.
     *   <li><code>inputReader</code> is an instance of "Reader".
     * </ul>
     *
     ...
     *
     * <ul>
     *   <li>The "GamessReader" object is constructed.
     *   <li>GamessReader.input is constructed with the parameter given to the constructor.
     * </ul>
     *
     * <p><b>Implementation</b>: <br>
     * The second postcondition is not yet implemented.
     *
    ...
    public void testGamessReader() {
        ...
        Assert.assertTrue(
                "TEST: The inputReader is a Reader object.", this.inputReader instanceof Reader);
        Assert.assertNotNull(
                "TEST: The GamessReader object is constructed.", this.gamessReaderUnderTest);
     ...
     *
     * <ul>
     *   <li>The "GamessReader" only accepts "ChemFile" objects as input parameter.
     * </ul>
     */
    // TODO Update method comments with appropriate information.
    @Test
    public void testAccepts() {
        Assert.assertNotNull(
                "The GamessReader object is not constructed", this.gamessReaderUnderTest);
        Assert.assertTrue(
     ...
     *
     * <ul>
     *   <li>The <code>read(IChemObject object)</code> method must return a "IChemObject" instance.
     * </ul>
     *
