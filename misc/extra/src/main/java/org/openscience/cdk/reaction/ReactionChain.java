...
/**
 * Classes that extends the definition of reaction to a chain reaction. This is designed to contains
 * a set of reactions which are lineal linked as chain. That would mean no exist branches or cycles
 * and in this concept you have a start reaction and final reaction. Each reaction is included in a
 * step of the chain.
 *
...
public class ReactionChain extends ReactionSet {
    ...
    public int getReactionStep(IReaction reaction) {
        ...
        if (hashMapChain.containsKey(reaction)) return hashMapChain.get(reaction);
        else return -1;
    }
