...
public class GridGenerator {
    ...
    /**
     * Main method creates a grid between given boundaries (dimensions). The grid my be extended
     * over the given boundaries with the variable extendGrid.
     */
    ...
    /**
     * Method transforms the grid into pmesh format. Only grid points with specific value defined
     * with cutoff are considered.
     *
     * <pre>{@code
