 ...
 * This reader was developed from a small set of example log files, and therefore, is not guaranteed
 * to properly read all GAMESS output. If you have problems, please contact the author of this code,
 ...
 *
 * <ul>
 *   <li><b>Molecular coordinates</b>: Each set of coordinates is added to the ChemFile in the order
 *       they are found.
 * </ul>
 *
 ...
 *   <li><b>Energies</b>: They are associated with the previously read set of coordinates.
 *   <li><b>Normal coordinates of vibrations</b>: They are associated with the previously read set
 *       of coordinates.
 * </ul>
 *
 * <!-- <p><b>Security:</b> -->
 *
 * <p><b>References</b>: <br>
 * <a href="http://www.msg.ameslab.gov/GAMESS/GAMESS.html">GAMESS</a> is a quantum chemistry program
 * by Gordon research group atIowa State University.
 *
 * @cdk.module extra
 * @cdk.githash
 * @cdk.keyword Gamess
...
public class GamessReader extends DefaultChemObjectReader {
    ...
    /**
     * Double constant that contains the conversion factor from Bohr unit to &Aring;ngstrom unit.
     */
     ...
     *
     * <p>The "Reader" object may be an instantiable object from the "Reader" hierarchy. <br>
     * For more detail about the "Reader" objects that are really accepted by this "GamessReader"
     * see <code>accepts(IChemObject)</code> method documentation.
     *
    ...
    /**
     * Reads data from the "file system" file through the use of the "input" field, parses data and
     * feeds the ChemFile object with the extracted data.
     *
     ...
     */
    // TODO Answer the question : Is this method's name appropriate (given the fact that it do not
    // read a ChemFile object, but return it)?
    private IChemFile readChemFile(IChemFile file) throws IOException {
        IChemSequence sequence =
                file.getBuilder()
                        .newInstance(
                                IChemSequence
                                        .class); // TODO Answer the question : Is this line needed ?
        IChemModel model =
                file.getBuilder()
                        .newInstance(
                                IChemModel
            ...
            if (currentReadLine.indexOf("COORDINATES (BOHR)") >= 0) {
                ...
                moleculeSet.addAtomContainer(
                        this.readCoordinates(
                                file.getBuilder().newInstance(IAtomContainer.class),
    ...
    /**
     * Reads a set of coordinates from the "file system" file through the use of the "input" field,
     * scales coordinate to angstr???m unit, builds each atom with the right associated coordinates,
     * builds a new molecule with these atoms and returns the complete molecule.
     *
     * <p><b>Implementation</b>: <br>
    ...
    private IAtomContainer readCoordinates(IAtomContainer molecule, boolean coordinatesUnits)
            throws IOException {
     ...
     *
     * <p><b>Implementation</b>: <br>
     * This is not a definitive method. It will probably be replaced with a more appropriate one. Be
     * advised that as it is not a definitive version, it only recognise atoms from Hydrogen (1) to
     * Argon (18).
     *
    ...
    /**
     * Scales coordinates to &Aring;ngstr&ouml;m unit if they are given in Bohr unit. If coordinates
     * are already given in &Aring;ngstr&ouml;m unit, then no modifications are performed.
     *
     * @param coordinatesUnits <code>BOHR_UNIT</code> if coordinates are given in Bohr unit and
     *     <code>ANGSTROM_UNIT</code> if they are given in &Aring;ngstr&ouml;m unit.
     * @return The scaling conversion factor: 1 if no scaling is needed and <code>BOHR_TO_ANGSTROM
     *     </code> if scaling has to be performed.
