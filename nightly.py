...
# in the classpath variable below. However if not specified, then no
...
#
# nightly_repo - should point to an SVN repo, within which doing
#                ant dist-all should work.
# nightly_dir  - should point to a directory in which this script
#                is to be placed and will contain log files
#                generated by the script.
# nightly_web  - points to a web accessible directory where the
