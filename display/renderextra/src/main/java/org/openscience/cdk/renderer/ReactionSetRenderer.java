...
public class ReactionSetRenderer extends AbstractRenderer<IReactionSet>
    ...
    /**
     * A renderer that generates diagrams using the specified generators for {@link IAtomContainer}s
     * and {@link IReactionSet}s and manages fonts with the supplied font manager.
     *
     * @param generators a list of classes that implement the {@link IGenerator} interface
     * @param reactionGenerators a list of classes that implement the {@link IGenerator} interface
     * @param fontManager a class that manages mappings between zoom and font sizes
     */
    public ReactionSetRenderer(
            List<IGenerator<IAtomContainer>> generators,
    ...
    /**
     * Set the scale for an IReactionSet. It calculates the average bond length of the model and
    ...
    public void paint(
        ...
        this.setupTransformToFit(
                bounds,
                totalBounds,
                AverageBondLengthCalculator.calculateAverageBondLength(reactionSet),
                resetCenter);
