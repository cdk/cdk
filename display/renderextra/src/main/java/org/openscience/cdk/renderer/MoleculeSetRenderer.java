...
public class MoleculeSetRenderer extends AbstractRenderer<IAtomContainerSet>
    ...
    /**
     * Set the scale for an {@link IAtomContainerSet}. It calculates the average bond length of the
     * model and calculates the multiplication factor to transform this to the bond length that is
     * set in the RendererModel.
     *
     * @param moleculeSet the {@link IAtomContainerSet} for what to set the scale
     */
    @Override
    ...
    public void paint(
        ...
        this.setupTransformToFit(
                bounds,
                totalBounds,
                AverageBondLengthCalculator.calculateAverageBondLength(molecules),
                resetCenter);
