...
/**
 * A selection of some atoms and bonds from an {@link IAtomContainer} or {@link IChemModel}.
 *
 * @author maclean
 * @cdk.module render
 * @cdk.githash
...
public interface IChemObjectSelection {
    ...
    /**
     * Perform a selection by some method. This is used for selecting outside the hub, for example:
     *
     * <p>IChemModel model = createModelBySomeMethod(); selection.select(model);
    ...
    /**
     * Returns a {@link Collection} of all selected {@link IChemObject}s of the given type.
     *
