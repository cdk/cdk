 ...
 * CDKAtomTypeMatcher} or with any compatible class.
 *
 * <p>But unlike the {@link CDKHueckelAromaticityDetector}, this one accepts ring atoms with double
 * bonds pointing out of the ring.
 *
 * @author egonw
 * @cdk.module standard
 * @cdk.githash
 ...
 * @deprecated use {@link Aromaticity} with the {@link
 *     org.openscience.cdk.aromaticity.ElectronDonation#cdkAllowingExocyclic()} model
 */
@Deprecated
