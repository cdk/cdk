...
/**
 * Basic implementation of AST nodes. Automatically generated by JJTree with some manual changes.
 *
 * @author Dazhi Jiao
...
class SimpleNode implements Node, Cloneable {
    ...
    public Object clone() {
        ...
        try {
            constructor =
                    this.getClass().getConstructor(new Class[] {SMARTSParser.class, Integer.TYPE});
