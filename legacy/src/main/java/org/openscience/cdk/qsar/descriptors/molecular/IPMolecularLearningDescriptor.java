...
/**
 * This class returns the ionization potential of a molecule. Up to now is only possible for
 * atomContainers which contain; see IPAtomicDescriptor and IPBondDescriptor.
 *
 * <p>The descriptor assumes that explicit hydrogens have been added to the molecule
 *
 ...
 */
@Deprecated
public class IPMolecularLearningDescriptor extends AbstractMolecularDescriptor
    ...
    public DescriptorValue calculatePlus(IAtomContainer container) throws CDKException {
        ...
        for (Iterator<IBond> itB = container.bonds().iterator(); itB.hasNext(); ) {
            ...
            if (bond.getOrder() == IBond.Order.DOUBLE
                    & bond.getBegin().getSymbol().equals("C")
