...
/**
 * This class handles MCS between two identical molecules. Hence they generate am MCS where all
 * atoms are mapped.
 *
 * @cdk.module smsd
 * @cdk.githash
...
public class ExactMapping {
     ...
     * @param cliqueListOrg
     */
    private static List<Integer> extractCliqueMapping(
            List<Integer> compGraphNodes, List<Integer> cliqueListOrg) {
     ...
     * @return mappings
     */
    public static List<List<Integer>> extractMapping(
