 ...
 *
 * <p>This program is free software; you can redistribute iterator and/or modify iterator under the
 * terms of the GNU Lesser General Public License as published by the Free Software Foundation;
 * either version 2.1 of the License, or (at your option) any later version. All we ask is that
 * proper credit is given for our work, which includes - but is not limited to - adding the above
 * copyright notice to the beginning of your source code files, and to any copyright notice that you
 * may distribute with programs based on this work.
 *
 * <p>This program is distributed in the hope that iterator will be useful, but WITHOUT ANY
