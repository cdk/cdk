...
/**
 * An CDKRMap implements the association between an edge (bond) in G1 and an edge (bond) in G2, G1
 * and G2 being the compared graphs in a RGraph context.
 *
 * @author Stephane Werner, IXELIS &lt;mail@ixelis.net&gt;, Syed Asad Rahman &gt;asad@ebi.ac.uk&lt;
