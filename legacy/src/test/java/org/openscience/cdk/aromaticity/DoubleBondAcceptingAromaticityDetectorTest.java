...
public class DoubleBondAcceptingAromaticityDetectorTest extends CDKTestCase {
    ...
    public void testConstructor() {
        ...
        DoubleBondAcceptingAromaticityDetector detector =
                new DoubleBondAcceptingAromaticityDetector();
    ...
    public void testNMethylPyrrol() throws Exception {
        ...
        AtomContainerManipulator.percieveAtomTypesAndConfigureAtoms(mol);
        Assert.assertTrue(
                "Expected the molecule to be aromatic.",
    ...
    public void testFuran() throws Exception {
        ...
        AtomContainerManipulator.percieveAtomTypesAndConfigureAtoms(mol);
        Assert.assertTrue(
                "Molecule is not detected aromatic",
                DoubleBondAcceptingAromaticityDetector.detectAromaticity(mol));
    ...
    public void testThiazole() throws Exception {
        ...
        AtomContainerManipulator.percieveAtomTypesAndConfigureAtoms(molecule);
        Assert.assertTrue(
                "Molecule is not detected as aromatic",
                DoubleBondAcceptingAromaticityDetector.detectAromaticity(molecule));
    ...
    /**
     * Tests that 1-4 benzoquinone is detected to be aromatic by the
     * DoubleBondAcceptingAromaticityDetector but not the CDKHueckelAromaticityDetector
     */
    @Test
    public void testBenzoquinone() throws Exception {
        ...
        IBond c1o7 =
                builder.newInstance(IBond.class, benzoquinone.getAtom(0), o7, IBond.Order.DOUBLE);
        IBond c4o8 =
                builder.newInstance(IBond.class, benzoquinone.getAtom(3), o8, IBond.Order.DOUBLE);
        ...
        Assert.assertFalse(
                "Hueckel method detect aromaticity", Aromaticity.cdkLegacy().apply(benzoquinone));
        Assert.assertTrue(
                "DoubleBond Accepting AromaticityDetector method did not detect aromaticity",
