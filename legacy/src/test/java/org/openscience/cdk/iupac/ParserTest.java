...
public class ParserTest extends CDKTestCase {
    ...
    public void testEthane() throws Exception {
        ...
        Assert.assertTrue(
                "The molecule built by the parser isn't the same as the expected one",
    ...
    public void testEicosane() throws Exception {
        IAtomContainer parserMolecule =
                NomParser.generate("Eicosane", SilentChemObjectBuilder.getInstance());
    ...
    public void testTokenMgrErrorCharacterName() throws Exception {
        try {
            ...
            Assert.fail(
                    "Molecule was successfully generated but should have thrown a TokenMgrError");
        } catch (ParseException pe) {
            Assert.fail(
                    "The molecule did throw a class, but it incorrectly threw a ParseException,"
    ...
    public void testParseExceptionNoName() {
        try {
            ...
            Assert.fail(
                    "Molecule was successfully generated but should have thrown a ParseException");
        } catch (ParseException pe) {
            Assert.assertTrue(true);
        } catch (CDKException exception) {
            Assert.fail(exception.getMessage());
