...
public class MassToFormulaToolTest extends CDKTestCase {
    ...
    public void testValidation_Orthinine() {
        ...
        Assert.assertEquals(
                mf1.getIsotopeCount(carb), mfSet.getMolecularFormula(0).getIsotopeCount(carb));
        Assert.assertEquals(
                mf1.getIsotopeCount(ifac.getMajorIsotope("N")),
                mfSet.getMolecularFormula(0).getIsotopeCount(ifac.getMajorIsotope("N")));
        ...
        Assert.assertEquals(
                mf2.getIsotopeCount(ifac.getMajorIsotope("C")),
                mfSet.getMolecularFormula(1).getIsotopeCount(ifac.getMajorIsotope("C")));
        Assert.assertEquals(
                mf2.getIsotopeCount(ifac.getMajorIsotope("N")),
                mfSet.getMolecularFormula(1).getIsotopeCount(ifac.getMajorIsotope("N")));
    }
    ...
    public void testValidation_Orthinine_Restrictions() throws Exception {
        ...
        Assert.assertEquals(mf1.getIsotopeCount(), mfSet.getMolecularFormula(0).getIsotopeCount());
        Assert.assertEquals(
                mf1.getIsotopeCount(ifac.getMajorIsotope("C")),
                mfSet.getMolecularFormula(0).getIsotopeCount(ifac.getMajorIsotope("C")));
        Assert.assertEquals(
                mf1.getIsotopeCount(ifac.getMajorIsotope("N")),
                mfSet.getMolecularFormula(0).getIsotopeCount(ifac.getMajorIsotope("N")));
    }
    ...
    public void testValidation_Arginine_Restrictions() throws Exception {
        ...
        Assert.assertEquals(
                mf1.getIsotopeCount(ifac.getMajorIsotope("C")),
                mfSet.getMolecularFormula(13).getIsotopeCount(ifac.getMajorIsotope("C")));
        Assert.assertEquals(
                mf1.getIsotopeCount(ifac.getMajorIsotope("N")),
                mfSet.getMolecularFormula(13).getIsotopeCount(ifac.getMajorIsotope("N")));
    }
     ...
     * @return The test suite
     * @cdk.inchi
     *     InChI=1/C8H9Cl3NO2PS/c1-12-15(16,13-2)14-8-4-6(10)5(9)3-7(8)11/h3-4H,1-2H3,(H,12,16)
     */
    @Test
    ...
    public void testDifferentIsotopes() throws Exception {
        ...
        Assert.assertEquals(mf1.getIsotopeCount(), mfSet.getMolecularFormula(0).getIsotopeCount());
        Assert.assertEquals(
                mf1.getIsotopeCount(carbon12),
                mfSet.getMolecularFormula(0).getIsotopeCount(carbon12));
        Assert.assertEquals(
                mf1.getIsotopeCount(carbon13),
                mfSet.getMolecularFormula(0).getIsotopeCount(carbon13));
    }
