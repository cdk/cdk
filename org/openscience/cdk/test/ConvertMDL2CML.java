 ...
 * $Revision$
 * 
 * Copyright (C) 2001  The CompChem project
 * 
...
public class ConvertMDL2CML {
	...
	if (args.length == 2) {
	    new ConvertMDL2CML(args[0], args[1]);
	} else {
	    System.out.println("Syntax: ConvertMDL2CML <inputfile> <outputfile>");
	}
    }
}
